    ...
    <div class="well">
        <div class="panel panel-default">
          <!-- Default panel contents -->
            <div class="panel-heading panel-leasing"><i class="fa fa-list"></i> Long Term For Review</div>
            <div class="panel-body">
                ...
                <div class="row">
                    <div class="col-md-12">
                        <table class="table table-bordered" ng-controller="tableController" ng-init="loadList('<?php echo base_url(); ?>index.php/leasing_transaction/get_ltforreview')">
                            <thead>
                                <tr>
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="row">
                                <div class="form-group">
                                    ...
                                    <div class="col-md-8">
                                        <div> <span class = "details red" >{{ data.status }}</span></div>
                                    </div>
                                </div>
                            </div>
                            <div class="row">
