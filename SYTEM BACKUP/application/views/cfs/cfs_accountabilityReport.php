<div class="container" id = "transactionController" ng-controller="transactionController" >
    <div class="well">
        <div class="panel panel-default">
            <div class="panel-heading" style="background-color:#125821; color:whitesmoke"><i class="fa fa-pencil-square"></i> Accountability Report</div>
                        ...
                        <div class="tab-content ng-cloak">
                            <div role="tabpanel" class="tab-pane active" id="preop">
                                <div class="col-md-10 col-md-offset-3" style="padding-top: 4%;">
                                    <div class="row">
                                        <form action="" onSubmit = "generate_accountabilityReport('<?php echo base_url(); ?>index.php/Leasing_reports/cfs_accountabilityReport');return false"  method="post" id="frm_accountability" name = "frm_accountability">
                                            <div class="row">
                                                            ...
                                                            <div class="col-md-8 text-left">
                                                                <div class="input-group">
                                                                    ...
                                                                    <div class="validation-Error">
                                                                        <span ng-show="frm_accountability.beginning_date.$dirty && frm_accountability.beginning_date.$error.required">
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <div class="col-md-8 text-left">
                                                                <div class="input-group">
                                                                    ...
                                                                    <!-- FOR ERRORS -->
                                                                    <div class="validation-Error">
                                                                        <span ng-show="frm_accountability.end_date.$dirty && frm_accountability.end_date.$error.required">
                                                                            <p class="error-display">This field is required.</p>
                                                                        </span>
                                                                    </div>
                                                                </div>
                                            ...
                                            <div class="col-md-6">
                                                <div class="row pull-right" style="padding-right: 13%">
                                                    <div class = "col-md-12">
                                                        <button type = "submit" ng-disabled = "frm_accountability.$invalid" class = "btn btn-primary btn-lg"><i class = "fa fa-doc"></i> Generate Report</button>
                                                    </div>
                                                </div>
                                            </div>
                                        </form>
