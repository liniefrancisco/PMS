                                	...
                                	<table class="table table-bordered" id="creditmemo_table">
                                        ...
                                        <tbody id = "creditmemo_tbody">
                                        	<tr ng-repeat = "data in basicData">
                                        		...
                                        		<td>
                                        			<button type="button" ng-click = "apply_DebitMemo(data.id, data.description, data.balance)" class="btn btn-xs btn-danger">Apply Debit</button>
                                        		</td>
                                        	</tr>
                                        </tbody>
                                	</table>
    ...
    <div class="modal fade" id = "modal_debitMemo" style="top: 70px">
        <div class="modal-dialog modal-sm">
            <div class="modal-content">
                ...
                <form action = "<?php echo base_url(); ?>index.php/leasing_transaction/other_debitMemo/" method="post" name = "frm_debitMemo" id = "frm_debitMemo">
                                    ...
                                    <div class="form-group">
                                        <div class="col-md-12">
                                            ...
                                            <div class="validation-Error">
                                                <span ng-show="frm_debitMemo.debit_amount.$dirty && frm_debitMemo.debit_amount.$error.required">
                                                    <p class="error-display">This field is required.</p>
                                                </span>
                                                 <span ng-show="frm_debitMemo.debit_amount.$dirty && frm_debitMemo.debit_amount.$error.max">
    ...
    <div class="modal fade" id = "basic_debitMemo_modal" style="top: 70px">
        <div class="modal-dialog modal-sm">
            <div class="modal-content">
                ...
                <form action= "<?php echo base_url(); ?>index.php/leasing_transaction/basic_debitMemo/" method="post" name = "frm_debitMemo" id = "frm_creditMemo">
                    <div class="modal-body">
                        <div class="row">
                            <div class="col-md-12">
                                <div class="row">
                                    <div class="form-group">
                                        <div class="col-md-12">
                                            ...
                                            <input type = "text" name = "ledger_id" style = "display:none" ng-model = "ledger_id" id = "ledger_id" />
                                             <!-- FOR ERRORS -->
                                            <div class="validation-Error">
                                                <span ng-show="frm_debitMemo.debit_amount.$dirty && frm_debitMemo.debit_amount.$error.required">
                                                    <p class="error-display">This field is required.</p>
                        ...
                        <div class="modal-footer">
                            <button type="submit" ng-disabled = "frm_debitMemo.$invalid" class="btn btn-primary"> <i class="fa fa-save"></i> Submit</button>
                            <button type="button" class="btn btn-alert" data-dismiss="modal"> <i class="fa fa-close"></i> Close</button>
                        </div>
                    </div><!-- /.modal-content -->
                </form>
