            ...
            <div class="panel-body">
                <div class="row">
                    ...
                    <div class="col-md-3 pull-left">
                        <a href="#" data-backdrop="static" ng-click = "generate_locationCodeID()" data-keyboard="false" data-toggle="modal" data-target="#add_data" class = "btn btn-success btn-medium"><i class = "fa fa-plus-circle"></i> Add Data</a>
                    </div>
                    <?php endif ?>
                </div>
                <div class="row">
