        ...
        <div class="panel panel-default">
          <!-- Default panel contents -->
            ...
            <div class="panel-body">
                ...
                <div class="row">
                    <div class="col-md-12">
                        <table class="table table-bordered" ng-table = "tableParams" ng-controller="tableController" ng-init="loadList('<?php echo base_url(); ?>index.php/leasing_mstrfile/get_areaType')">
                            <tbody>
                                    ...
                                    <td title = "'Action'">
                                        ...
                                        <div class="btn-group">
                                            ...
                                            <ul class="dropdown-menu">
                                                <li><a href="#" data-backdrop="static" data-keyboard="false" data-toggle="modal" data-target="#update_modal" ng-click="update('<?php echo base_url(); ?>index.php/leasing_mstrfile/get_areaType_data/' + dt.id)"> <i class = "fa fa-edit"></i> Update</a></li>
                                                <li><a href="#" data-toggle="modal" data-target="#confirmation_modal" ng-click="delete('<?php echo base_url(); ?>index.php/leasing_mstrfile/delete_areaType/' + dt.id)"> <i class = "fa fa-trash"></i> Delete</a></li>
                                            </ul>
                                        </div>
                                    </td>    
                                    <?php endif ?>
    ...
    <div class="modal fade" id = "add_data">
        <div class="modal-dialog modal-md">
            <div class="modal-content">
                ...
                <form action="<?php echo base_url(); ?>index.php/leasing_mstrfile/add_areaType" name="add_form" method="post">
                    <div class="modal-body">
                        <div class="row">
                            <div class="col-md-10 ">
                                <div class="row">
                                    <div class="form-group">
                                        <label for="type" class="col-md-4 control-label text-right"><i class = "fa fa-asterisk"></i>Area Type</label>
                                        <div class="col-md-8">
                                            <input 
                                                type="text" 
                                                required 
                                                ...
                                                name = "type"
                                                is-unique
                                                is-unique-api="../ctrl_validation/verify_areaType/"
                                                autocomplete="off" >
                                            <!-- FOR ERRORS -->
                                ...
                                <div class="row">
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-8">
                                            ...
                                            <!-- FOR ERRORS -->
                                            <div class="validation-Error">
                                                <span ng-show="frm_update.type.$dirty && frm_update.type.$error.required">
                                                    <p class="error-display">This field is required.</p>
                                                </span>
                                                <span ng-show="frm_update.type.$dirty && frm_update.type.$error.minlength">
                                                    <p class="error-display">Minimum of 5 characters</p>
                                                </span>
