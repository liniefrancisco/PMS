                ...
                <div class="col-md-12">
                    <div class="row">
                        ...
                        <div class="tab-content ng-cloak">
                            ...
                            <form action="" onsubmit="save_closingRentDue('<?php echo base_url(); ?>index.php/leasing_transaction/save_closingRentDue'); return false" enctype="multipart/form-data" method="post"  name = "frm_closingRentDue" id = "frm_closingRentDue">
                                <div role="tabpanel" class="tab-pane active" id="payment">
                                        ...
                                        <div class="col-md-10 col-md-offset-1">
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <div class="row">
                                                        <div class="form-group">
                                                            <label for="JV_no" class="col-md-5 control-label text-right"><i class="fa fa-asterisk"></i>JV No.</label>
                                                            <div class="col-md-7">
                                                                <input
                                                                    type = "text"
                                                                    ng-model="JV_no"
                                                                ...
                                                                <div class="validation-Error">
                                                                    <span ng-show="frm_closingRentDue.JV_no.$dirty && frm_closingRentDue.JV_no.$error.required">
                                                                        <p class="error-display">This field is required.</p>
                                                                    </span>
                                                                    <span ng-show="frm_closingRentDue.JV_no.$dirty && frm_closingRentDue.JV_no.$error.unique">
                                                ...
                                                <div class="col-md-6"> <!-- COL-MD-6 DIVIDER -->
                                                    ...
                                                    <div class="row">
                                                        <div class="form-group">
                                                            <label for="JV_doc" class="col-md-5 control-label text-right"><i class="fa fa-asterisk"></i>JV Document</label>
                                                            <div class="col-md-7">
                                                                <input
                                                                    type = "file"
                                                                    required
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <div class="col-md-7">
                                                                <div class="input-group">
                                                                    ...
                                                                    <!-- FOR ERRORS -->
                                                                    <div class="validation-Error">
                                                                        <span ng-show="frm_closingRentDue.transaction_date.$dirty && frm_closingRentDue.transaction_date.$error.required">
                                                                            <p class="error-display">This field is required.</p>
                                                                        </span>
                                                                    </div>
                                                                </div>
                                                    ...
                                                    <div class="row">
                                                            <div class="form-group">
                                                                <label for="tender_amount" class="col-md-5 control-label text-right"><i class="fa fa-asterisk"></i>Tender Amount</label>
                                                                <div class="col-md-7">
                                                                    <div class="input-group">
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="row">
                                                <div class="col-md-12" ng-init = "get_unCloseRentDue('<?php echo base_url(); ?>index.php/leasing_transaction/get_unCloseRentDue/' + '<?php echo $value['tenant_id']; ?>')">
                                                    <table class="table table-bordered" id="payment_table">
                                                        ...
                                                        <tbody id="payment_tbody">
                                                            <tr ng-repeat = "data in unCloseRentDue">
                                                                <td style="display:none"><input type = "text" style = "display:none" name = "entry_id[]" ng-model="data.id" /> {{data.id}}</td>
                                                                <td><input type = "text" style = "display:none" name = "doc_no[]" ng-model = "data.doc_no" /> {{data.doc_no}}</td>
                                                                <td><input type = "text" style = "display:none" name = "desc[]" value="" /> Rent Due</td>
                                                                <td><input type = "text" style = "display:none" name = "ref_no[]" ng-model = "data.posting_date"  /> {{data.ref_no}}</td>
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <button role = "submit" ng-disabled = "frm_closingRentDue.$invalid" class="btn btn-large btn-primary col-md-1 col-md-offset-10"><i class="fa fa-save"></i> Submit</button>
                                        </div>
                                    </div>
                                </div>
                            </form>
