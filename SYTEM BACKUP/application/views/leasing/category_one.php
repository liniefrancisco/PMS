            ...
            <div class="panel-body">
                ...
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <table class="table table-bordered" ng-table="tableParams" ng-controller="tableController" ng-init="loadList('<?php echo base_url(); ?>index.php/leasing_mstrfile/get_category_one')">
                            
                            <tbody>
                                <tr class="ng-cloak" ng-repeat= "category in data">
                                    <td title="'ID'" sortable="'id'">{{ category.id }}</td>
                                    <td title="'Category Name'" sortable="'category_name'">{{ category.category_name }}</td>
                                    ...
                                    <td title = "'Action'">
                                        ...
                                        <div class="btn-group">
                                            ...
                                            <ul class="dropdown-menu">
                                                <li><a href="#" data-backdrop="static" data-keyboard="false" data-toggle="modal" data-target="#update_modal" ng-click="update_category_one('<?php echo base_url(); ?>index.php/leasing_mstrfile/get_categoryOne_data/' + category.id)"> <i class = "fa fa-edit"></i> Update</a></li>
                                                <li><a href="#" data-backdrop="static" data-keyboard="false" data-toggle="modal" data-target="#confirmation_modal" ng-click="delete('<?php echo base_url(); ?>index.php/leasing_mstrfile/delete_categoryOne/' + category.id)"> <i class = "fa fa-trash"></i> Delete</a></li>
                                            </ul>
                                        </div>
                                    </td>
                                    <?php endif ?>
        ...
        <div class="modal-dialog modal-md">
            <div class="modal-content">
                ...
                <div class="modal-body" ng-repeat = "data in categoryData">
                    <form action = "{{ 'update_categoryOne/' + data.id }}" method="post" name = "frm_update" id = "frm_update">
                        <div class="row">
                            <div class="col-md-10">
                                <div class="row">
                                    <div class="form-group">
                                        <label for="store_name" class="col-md-4 control-label text-right"><i class = "fa fa-asterisk"></i>Category Name</label>
                                        <div class="col-md-8">
                                            <input 
                                                type="text" 
                                                required 
                                            ...
                                            <div class="validation-Error">
                                                <span ng-show="frm_update.category_name.$dirty && frm_update.category_name.$error.required">
                                                    <p class="error-display">This field is required.</p>
                                                </span>
                                                <span ng-show="frm_update.category_name.$dirty && frm_update.category_name.$error.minlength">
                                                    <p class="error-display">Minimum of 5 characters</p>
                                                </span>
                                                <span ng-show="frm_update.category_name.$dirty && frm_update.category_name.$error.unique">
    ...
    <div class="modal fade" id = "add_data">
        <div class="modal-dialog modal-md">
            <div class="modal-content">
                ...
                <form action="<?php echo base_url(); ?>index.php/leasing_mstrfile/add_category_one" name="add_form" method="post">
                    <div class="modal-body">
                        <div class="row">
                            <div class="col-md-10 ">
                                <div class="row">
                                    <div class="form-group">
                                        <label for="category_name" class="col-md-4 control-label text-right"><i class = "fa fa-asterisk"></i>Category Name</label>
                                        <div class="col-md-8">
                                            <input 
                                                type="text" 
                                                required 
                                                ...
                                                name = "category_name"
                                                is-unique
                                                is-unique-api="../ctrl_validation/verify_category_one/"
                                                autocomplete="off" >
                                            <!-- FOR ERRORS -->
                                            <div class="validation-Error">
                                                <span ng-show="add_form.category_name.$dirty && add_form.category_name.$error.required">
                                                    <p class="error-display">This field is required.</p>
                                                </span>
                                                <span ng-show="add_form.category_name.$dirty && add_form.category_name.$error.minlength">
                                                    <p class="error-display">Minimum of 5 characters</p>
                                                </span>
                                                <span ng-show="add_form.category_name.$dirty && add_form.category_name.$error.unique">
                                                    <p class="error-display">Data already exist.</p>
                                                </span>
                                            </div>  
                                        </div>
