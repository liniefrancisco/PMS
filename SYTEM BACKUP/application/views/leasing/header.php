            ...
            <div class="nav-container">
                <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                    <ul class="nav navbar-nav">
                        ...
                        <?php if ($this->session->userdata('user_type') != 'Administrator'): ?>
                            <li class="dropdown"><a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false"><i class="fa fa-cogs"></i> Transaction <span class="caret"></span></a>
                                <ul class="dropdown-menu multi-level" role="menu" aria-labelledby="dropdownMenu">
                                    ...
                                    <li class="dropdown-submenu"> <a tabindex="1" href="#"><i class="fa fa-columns"></i> Invoicing</a>
                                        <ul class="dropdown-menu">
                                            <li><a tabindex="-1" href="<?php echo base_url(); ?>index.php/leasing_transaction/invoicing">Create Invoice</a></li>
                                    ...
                                    <li class="dropdown-submenu"> <a tabindex="1" href="#"><i class="fa fa-columns"></i> Statement of Account</a>
                                        <ul class="dropdown-menu">
                                            <li><a tabindex="-1" href="<?php echo base_url(); ?>index.php/leasing_transaction/soa">Create SOA(Per Tenant)</a></li>
                                    ...
                                    <li class="dropdown-submenu"><a tabindex="1" href="#"><i class="fa fa-credit-card"></i> Payment</a>
                                        <ul class="dropdown-menu">
                                            <li><a href="<?php echo base_url(); ?>index.php/leasing_transaction/payment">Regular Payment</a></li>
                                            <li><a tabindex="-1" href="<?php echo base_url(); ?>index.php/leasing_transaction/preop_payment">Using Preop Charges</a></li>
                                            <li><a tabindex="-1" href="<?php echo base_url(); ?>index.php/leasing_transaction/advance_payment">Advance Payment</a></li>
                        ...
                        <li class="dropdown"><a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false"><i class="fa fa-archive"></i> Archive <span class="caret"></span></a>
                            <ul class="dropdown-menu multi-level" role="menu" aria-labelledby="dropdownMenu">
                                <li class="dropdown-submenu"><a tabindex="-1" href="#"><i class="fa fa-file-archive-o "></i> Denied Prospect</a>
                                    <ul class="dropdown-menu">
                    ...
                    <ul class="nav navbar-nav navbar-right">
                        <li class="dropdown notification-dropdown"><a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false"><i class=""></i> Notification<span class="badge" style="background-color:red"><?php echo count($expiry_tenants); ?></span></a>
                            <ul class="dropdown-menu notifications" role="menu" aria-labelledby="dLabel">
                                <div class="notification-heading"><h4 class="menu-title">Contracts to expire.</h4><h4 class="menu-title pull-right"></div>
                                <li class="divider"></li>
