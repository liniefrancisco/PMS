<div class="container" id = "transactionController" ng-controller="transactionController" >
    <div class="well">
        <div class="panel panel-default">
            <div class="panel-heading panel-leasing"><i class="fa fa-pencil-square"></i> Statement of Account(Per Batch)</div>
                        ...
                        <div class="tab-content ng-cloak">
                            <div role="tabpanel" class="tab-pane active" id="preop">
                                <div class="col-md-10 col-md-offset-1 ">
                                    <div class="row">
                                        <form action="" onsubmit="save_soa('<?php echo base_url(); ?>index.php/leasing_transaction/generate_batchSOA/'); return false;"  method="post" id="frm_soa" name = "frm_soa">
                                            <div class="row">
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <div class="col-md-7" >
                                                                ...
                                                                <?php for ($i=0; $i < count($billing_period); $i++) :?>
                                                                    <option><?php echo $billing_period[$i] . " " . $current_year; ?></option>
                                                                <?php endfor ?>
                                                                </select>
                                                            </div>
                                                        </div>
                                                ...
                                                <div class="col-md-6">
                                                    <div class="row">
                                                        <div class="row">
                                                            <div class="form-group">
                                                                <label for="collection_date" class="col-md-3 control-label text-right">Collection Date</label>
                                            ...
                                            <div class="row"> <!-- ROW FOR BUTTONS -->
                                                <div class = "col-md-12 text-center">
                                                    <button type = "submit" ng-disabled = "frm_soa.$invalid" class = "btn btn-primary btn-lg"><i class = "fa fa-doc"></i> Generate SOA</button>
                                                </div>
                                            </div>
                                        </form>
                                    </div>
