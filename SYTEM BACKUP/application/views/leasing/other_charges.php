    ...
    <div class="well">
        <div class="panel panel-default">
          <!-- Default panel contents -->
            <div class="panel-heading panel-leasing"><i class="fa fa-list"></i> OTHER CHARGES</div>
            <div class="panel-body">
                <div class="row">
                    ...
                    <div class="col-md-3 pull-left">
                        <a href="#" data-toggle="modal" data-target="#add_data" class = "btn btn-success btn-medium"><i class = "fa fa-plus-circle"></i> Add Data</a>
                    </div>
                </div>
                <div class="row">
                    <div class="col-md-12">
                        <table class="table table-bordered" ng-controller="tableController" ng-init="loadList('<?php echo base_url(); ?>index.php/leasing_mstrfile/get_other_charges')">
                            <thead>
                                <tr>
                                    <th width="15%"><a href="#" data-ng-click="sortField = 'description'; reverse = !reverse">Description</a></th>
                                    <th width="15%"><a href="#" data-ng-click="sortField = 'uom'; reverse = !reverse">Unit of Measure</a></th>
                                    <th width="15%"><a href="#" data-ng-click="sortField = 'amount'; reverse = !reverse">Amount</a></th>
                                    ...
                                    <td>
                                        ...
                                        <div class="btn-group">
                                            ...
                                            <ul class="dropdown-menu">
                                                <li><a href="#" data-toggle="modal" data-target="#update_modal" ng-click="update('<?php echo base_url(); ?>index.php/leasing_mstrfile/get_otherCharges_data/' + charges.id)"> <i class = "fa fa-edit"></i> Update</a></li>
                                                <li><a href="#" data-toggle="modal" data-target="#confirmation_modal" ng-click="delete('<?php echo base_url(); ?>index.php/leasing_mstrfile/delete_otherCharges/' + charges.id)"> <i class = "fa fa-trash"></i> Delete</a></li>
                                            </ul>
                                        </div>
                                    </td>
                                </tr>
        ...
        <div class="modal-dialog modal-md">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h4 class="modal-title"><i class="fa fa-edit"></i> Update Other Charges</h4>
                </div>
                <div class="modal-body" ng-repeat = "data in updateData">
                    <form action = "{{ 'update_otherCharges/' + data.id }}" method="post" name = "frm_update" id = "frm_update">
                        <div class="row">
                            <div class="col-md-11">
                                <div class="row">
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-8">
                                            <input 
                                                ...
                                                is-unique-api="../ctrl_validation/verify_otherCharges_update/">
                                            <!-- FOR ERRORS -->
                                ...
                                <div class="row">
                                    <div class="form-group">
                                        <label for="amount" class="col-md-4 control-label text-right"><i class = "fa fa-asterisk"></i>Amount</label>
                                        <div class="col-md-8">
                                            ...
                                            <div class="input-group">
                                                <div class="input-group-addon"><strong>&#8369;</strong></div>
                                                    ...
                                                    <!-- FOR ERRORS -->
                                                    <div class="validation-Error">
                                                        <span ng-show="frm_update.amount.$dirty && frm_update.amount.$error.required">
                                                            <p class="error-display">This field is required.</p>
                                                        </span>
                                                    </div>  
                                            </div>
    ...
    <div class="modal fade" id = "add_data">
        <div class="modal-dialog modal-md">
            <div class="modal-content">
                <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                    <h4 class="modal-title"><i class="fa fa-pencil"></i> Add Other Charges</h4>
                </div>
                <form action="<?php echo base_url(); ?>index.php/leasing_mstrfile/add_other_charges" name="add_form" method="post">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-8">
                                            <input 
                                                ...
                                                autocomplete="off" 
                                                is-unique
                                                is-unique-api="../ctrl_validation/verify_otherCharges/">
                                            <!-- FOR ERRORS -->
                                            <div class="validation-Error">
                                        ...
                                        <div class="col-md-8">
                                            ...
                                            <div class="input-group">
                                                <div class="input-group-addon"><strong>&#8369;</strong></div>
                                                    ...
                                                    <!-- FOR ERRORS -->
                                                    <div class="validation-Error">
                                                        <span ng-show="add_form.amount.$dirty && add_form.amount.$error.required">
                                                            <p class="error-display">This field is required.</p>
                                                        </span>
                                                    </div>  
                                            </div>
