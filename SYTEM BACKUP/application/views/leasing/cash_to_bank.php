            ...
            <div class="panel panel-default">
              <!-- Default panel contents -->
                ...
                <div class="panel-body">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <table class="table table-bordered" ng-table="tableParams" ng-controller="tableController" ng-init="loadList('<?php echo base_url(); ?>index.php/leasing_mstrfile/get_cashtobank/')">
                                <tbody>
                                        ...
                                        <td title="'Action'">
                                            ...
                                            <div class="btn-group">
                                                ...
                                                <ul class="dropdown-menu">
                                                    ...
                                                    <li>
                                                        <a  href="<?php echo base_url() ?>index.php/leasing_mstrfile/delete_cashbank/{{bank.id}}">
            ...
            <div class="modal-dialog modal-md">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form action = "<?php echo base_url(); ?>index.php/leasing_mstrfile/add_cashtobank" method="post" name = "frm_add" id = "frm_add">
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="row">
                                    ...
                                    <div class="row">
                                        <div class="form-group">
                                            <label for="company_code" class="col-md-4 control-label text-right"><i class = "fa fa-asterisk"></i>Bank Name</label>
                                            <div class="col-md-6">
                                                <select 
                                                    class="form-control"
                                                    required
                                    ...
                                    <div class="row">
                                        <div class="form-group">
                                            <label for="store_code" class="col-md-4 control-label text-right"><i class = "fa fa-asterisk"></i>Bank Code</label>
                                            <div class="col-md-6">
                                                <select 
                                                    class="form-control"
                                                    required
                            ...
                            <div class="modal-footer">
                                <button type="submit" ng-disabled = "frm_add.$invalid" class="btn btn-primary"> <i class = "fa fa-save"></i> Submit</button>
                            ...
                            <div class="col-md-12">
                                <div class="row">
                                    <div class="form-group">
                                        <label for="store_name" class="col-md-4 control-label text-right"><i class = "fa fa-asterisk"></i>Store Name</label>
                                        <div class="col-md-6">
                                            <input type = "text" name = "store_name" ng-model = "cb.store_name" readonly class = "form-control" />
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
