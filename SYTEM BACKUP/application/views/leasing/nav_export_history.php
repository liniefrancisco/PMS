                                ...
                                <div class=" row ">
                                    <div class="col-md-12">
                                        <table class="table table-bordered" ng-table = "tableParams" ng-controller="tableController" >           
                                            <tbody ng-init="loadList('<?=base_url('leasing_reports/get_nav_export_data')?>')">
                                                <tr class="ng-cloak" ng-repeat= "dt in data">
                                                    <td title = "'Batch Code'" sortable = "'batch_code'" align="center">{{ dt.batch_code }}</td>
                                                    <td title = "'Doc. Type'" sortable = "'type'" align="center">{{ dt.type }}</td>
                                                    <td title = "'Filter'" sortable = "'filter'" align="center">{{ dt.filter }}</td>
                                                    <td title = "'Store'" sortable = "'store'" align="center">{{ dt.store }}</td>
                                                    <td title = "'Exported By'" sortable = "'full_name'">{{ dt.full_name }}</td>
                                                    <td title = "'Date Exported'" sortable = "'exported_at'" align="center">{{ dt.exported_at }}</td>
                                                    <td title = "'Action'" align="center">
                                                        <a href="<?=base_url('leasing_reports/redownloadNavTextfile')?>/{{dt.id}}" 
                                                            target="_blank" 
                                                            class="btn btn-sm" style="padding: 3px 7px;"
                                                            title="Download Textfile">
                                                        ...
                                                        <button type="button"
                                                            ...
                                                            class="btn btn-sm btn-danger" style="padding: 3px 7px;"
                                                            title="Untag">
