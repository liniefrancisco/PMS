        ...
        <div class="panel panel-default">
          <!-- Default panel contents -->
            ...
            <div class="panel-body">
                ...
                <div class="row">
                    <div class="col-md-12">
                        <table class="table table-bordered" ng-controller="tableController" ng-init="loadList('<?php echo base_url(); ?>index.php/leasing_mstrfile/get_floorplan')">
                            <thead>
                                <tr>
                                    <th width="15%"><a href="#" data-ng-click="sortField = 'store_name'; reverse = !reverse">Store/Property Name</a></th>
                                    <th width="10%"><a href="#" data-ng-click="sortField = 'store_code'; reverse = !reverse">Company Code</a></th>
                                    <th width="25%"><a href="#" data-ng-click="sortField = 'store_address'; reverse = !reverse">Floor Name</a></th>
                                    <th width="25%"><a href="#" data-ng-click="sortField = 'store_address'; reverse = !reverse">File Name</a></th>
                                    <th width="10%">Action</th>
                                </tr>
                            </thead>
                            <tbody>
                                <tr class="ng-cloak" ng-show="dataList.length!=0" ng-repeat= "floor in dataList | filter:query | orderBy:sortField:reverse | offset: currentPage*itemsPerPage | limitTo: itemsPerPage">
                                    ...
                                    <td>
                                        ...
                                        <div class="btn-group">
                                            ...
                                            <ul class="dropdown-menu">
                                                ...
                                                <?php endif; ?>
                                                <li>
                                                    <a target="_blank" href="<?php echo base_url() ?>index.php/leasing_mstrfile/view_3D/{{floor.model}}">
                    ...
                    <div class="modal-body">
                        <div class="row">
                            <div class="col-md-10 col-md-offset-1">
                                <div class="row">
                                    <div class="form-group">
                                        <label for="store_name" class="col-md-3 control-label text-right"><i class = "fa fa-asterisk"></i>X3D File</label>
                                        <div class="col-md-9">
