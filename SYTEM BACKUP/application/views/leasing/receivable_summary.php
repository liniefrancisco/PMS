                        ...
                        <div class="tab-content ng-cloak">
                            <div role="tabpanel" class="tab-pane active" id="preop">
                                <div class="col-md-10 col-md-offset-3" style="padding-top: 4%;">
                                    <div class="row">
                                        <form action="" onSubmit="generate_receivable_summary('<?php echo base_url() ?>index.php/leasing_reports/generate_receivable_summary'); return false"  method="post" id="frm_receivableSummary" name = "frm_receivableSummary">
                                            <div class="row">
                                                            ...
                                                            <div class="col-md-8 text-left">
                                                                <div class="input-group">
                                                                    ...
                                                                    <div class="validation-Error">
                                                                        <span ng-show="frm_receivableSummary.as_of_date.$dirty && frm_receivableSummary.as_of_date.$error.required">
                                            ...
                                            <div class="col-md-6">
                                                <div class="row pull-right" style="padding-right: 13%">
                                                    <div class = "col-md-12">
                                                        <button type = "submit" ng-disabled = "frm_receivableSummary.$invalid" class = "btn btn-primary btn-lg"><i class = "fa fa-doc"></i> Generate Report</button>
                                                    </div>
                                                </div>
                                            </div>
                                        </form>
