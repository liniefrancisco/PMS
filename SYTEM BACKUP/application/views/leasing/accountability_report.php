                        ...
                        <div class="tab-content ng-cloak">
                            <div role="tabpanel" class="tab-pane active" id="preop">
                                <div class="col-md-10 col-md-offset-3" style="padding-top: 4%;">
                                    <div class="row">
                                        <form action="" onSubmit = "generate_accountabilityReport('<?php echo base_url(); ?>index.php/Leasing_reports/generate_accountabilityReport');return false"  method="post" id="frm_accountability" name = "frm_accountability">
                                            <div class="row">
                                                <div class="col-md-6"> <!-- SECOND COL-MD-6 WRAPPER -->
                                                    <div class="row">
                                                        <div class="form-group">
                                                            <label for="billing_period" class="col-md-4 control-label text-right"><i class="fa fa-asterisk"></i>User Name</label>
                                                            <div class="col-md-8" >
                                                                <select
                                                                    required
                                                                    class="form-control"
