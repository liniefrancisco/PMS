                            ...
                            <div role="tabpanel" class="tab-pane active" id="general_ledger">
                                <div class="row"> <!-- table wrapper  -->
                                            ...
                                            <div class="col-md-4">
                                                <div class="row pull-left">
                                                    <div class="form-group">
                                                        ...
                                                        <button type="button" ng-click = "ajaxLoadList('<?php echo base_url(); ?>index.php/leasing_reports/get_agingAR/', date_created)" class="btn btn-medium btn-info" name="button">Generate</button>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    <table class="table table-bordered" id="generalLedger_table"  ng-table = "ajaxTableParams">
                                    ...
                                    <div class="col-md-12" ng-if = "ajaxData.length!=0">
                                        <a class="btn btn-default btn-medium pull-right" onclick="generate_aging('<?php echo base_url(); ?>index.php/leasing_reports/export_agingAR/')"  ><i class="fa fa-download"></i> Export Excel</a>
                                    </div>
                                </div>
                            </div>
