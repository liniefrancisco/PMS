                                    ...
                                    <div role="tabpanel" class="tab-pane" id="Attachment">
                                        <div class="col-md-10 col-md-offset-1">
                                            <div class="panel panel-default">
                                                ...
                                                <div class="panel-body">
                                                    <div class="col-md-12">
                                                        <input id="contract_docs" name = "contract_docs[]" ng-model = "contract_docs" valid-file type="file" multiple="multiple">
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                        ...
                        <div class="row">
                            <div class="col-md-12 text-right">
                                <?php if ($this->session->userdata('user_type') == 'Administrator' || $this->session->userdata('user_type') == 'Store Manager' || $this->session->userdata('user_type') == 'Supervisor' || $this->session->userdata('user_type') == 'Corporate Leasing Supervisor'): ?>
                                    <button type = "button" onclick="add_tenant('<?php echo base_url(); ?>index.php/leasing_transaction/add_tenant/');" ng-disabled = "frm_contract.$invalid" class="btn btn-medium btn-primary"><i class = "fa fa-save"></i> Submit</button>
                                <?php else: ?>
                                    <button type = "button" data-toggle="modal" data-target="#tagAs_modal" ng-disabled = "frm_contract.$invalid" class="btn btn-medium btn-primary"><i class = "fa fa-save"></i> Submit</button>
                                <?php endif ?>
            ...
            <div class="modal-content">
                ...
                <form action="#"  method="post" id="frm_managerKey" name = "frm_managerKey">
                    ...
                    <div class="modal-footer">
                        <button type="button" onclick="add_tenant('<?php echo base_url(); ?>index.php/leasing_transaction/add_tenant/');" class="btn btn-primary" data-dismiss="modal"> <i class="fa fa-key"></i> Submit</button>
        ...
        <div class="modal-dialog modal-sm">
            <div class="modal-content">
                ...
                <form action="#"  method="post" id="frm_tag" name = "frm_tag">
                    ...
                    <div class="modal-footer">
                        <button type="button" onclick="checkTag('<?php echo base_url(); ?>index.php/leasing_transaction/pending_contract/')" class="btn btn-primary" data-dismiss="modal"> <i class="fa fa-save"></i> Proceed</button>
                    </div>
                </form>
            </div><!-- /.modal-dialog -->
        </div><!-- /.modal -->
