<div class="container" id = "transactionController" ng-controller="transactionController" >
    <div class="well">
        <div class="panel panel-default">
            <div class="panel-heading panel-leasing"><i class="fa fa-pencil-square"></i> Payment Ledger</div>
                        ...
                        <div class="tab-content ng-cloak">
                            <div role="tabpanel" class="tab-pane active" id="preop">
                                <div class="col-md-10 col-md-offset-3" style="padding-top: 4%;">
                                    <div class="row">
                                        <form action="<?php echo base_url() ?>index.php/leasing_reports/generate_paymentLedger"  method="post" id="frm_paymentLedger" name = "frm_paymentLedger">
                                            <div class="row">
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <div class="col-md-8 text-left">
                                                                ...
                                                                <div class="validation-Error">
                                                                    <span ng-show="frm_paymentLedger.month.$dirty && frm_paymentLedger.month.$error.required">
                                            ...
                                            <div class="col-md-6">
                                                <div class="row pull-right" style="padding-right: 13%">
                                                    <div class = "col-md-12">
                                                        <button type = "submit" ng-disabled = "frm_paymentLedger.$invalid" class = "btn btn-primary btn-lg"><i class = "fa fa-doc"></i> Generate Report</button>
                                                    </div>
                                                </div>
                                            </div>
                                        </form>
