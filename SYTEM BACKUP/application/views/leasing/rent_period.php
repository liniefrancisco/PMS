        ...
        <div class="panel panel-default">
          <!-- Default panel contents -->
            ...
            <div class="panel-body">
                ...
                <div class="row">
                    <div class="col-md-12">
                        <table class="table table-bordered" ng-table = "tableParams" ng-controller="tableController" ng-init="loadList('<?php echo base_url(); ?>index.php/leasing_mstrfile/get_rentPeriod')">
                                    ...
                                    <td width="10%" title="'Action'">
                                        ...
                                        <div class="btn-group">
                                            ...
                                            <ul class="dropdown-menu">
                                                <li><a href="#" data-backdrop="static" data-keyboard="false" data-toggle="modal" data-target="#update_modal" ng-click="update('<?php echo base_url(); ?>index.php/leasing_mstrfile/get_rentPeriod_data/' + dt.id)"> <i class = "fa fa-edit"></i> Update</a></li>
                                                <li><a href="#" data-toggle="modal" data-target="#confirmation_modal" ng-click="delete('<?php echo base_url(); ?>index.php/leasing_mstrfile/delete_rentPeriod/' + dt.id)"> <i class = "fa fa-trash"></i> Delete</a></li>
                                            </ul>
                                        </div>
                                    </td>    
                                    <?php endif ?>
    ...
    <div class="modal fade" id = "add_data">
        <div class="modal-dialog modal-md">
            <div class="modal-content">
                ...
                <form action="<?php echo base_url(); ?>index.php/leasing_mstrfile/add_rentPeriod" name="add_form" method="post">
                    <div class="modal-body">
                        <div class="row">
                            <div class="col-md-10 ">
                                <div class="row">
                                    <div class="form-group">
                                        <label for="type" class="col-md-4 control-label text-right"><i class = "fa fa-asterisk"></i>Tenancy Type</label>
                                        <div class="col-md-8">
                                ...
                                <div class="row">
                                    <div class="form-group">
                                        <label for="type" class="col-md-4 control-label text-right"><i class = "fa fa-asterisk"></i>UOM</label>
                                        <div class="col-md-8">
                                ...
                                <div class="row">
                                    <div class="form-group">
                                        <label for="type" class="col-md-4 control-label text-right"><i class = "fa fa-asterisk"></i>Number of {{uom}}(s)</label>
                                        <div class="col-md-8">
                                            <input 
                                                type="text" 
                                                required 
                                            ...
                                            <div class="validation-Error">
                                                <span ng-show="add_form.number.$dirty && add_form.number.$error.required">
                            ...
                            <div class="col-md-10">
                                <div class="row">
                                    <div class="form-group">
                                        <label for="type" class="col-md-4 control-label text-right"><i class = "fa fa-asterisk"></i>Tenancy Type</label>
                                        <div class="col-md-8">
                                            <select required name = "tenancy_type" ng-model = "data.tenancy_type" class="form-control">
                                                <option value="" disabled="" selected="" style="display:none">Please Select One</option>
                                                <option>Long Term</option>
                                                <option>Short Term</option>
                                            </select>
                                ...
                                <div class="row">
                                    <div class="form-group">
                                        <label for="type" class="col-md-4 control-label text-right"><i class = "fa fa-asterisk"></i>Number of {{data.uom}}(s)</label>
                                        <div class="col-md-8">
                                            <input 
                                                type="text" 
                                                required 
