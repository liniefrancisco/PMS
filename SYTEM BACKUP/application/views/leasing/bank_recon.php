                        ...
                        <div class="tab-content ng-cloak">
                            <div role="tabpanel" class="tab-pane active" id="preop">
                                <div class="col-md-10 col-md-offset-3" style="padding-top: 4%;">
                                    <div class="row">
                                        <form action="<?php echo base_url() ?>index.php/leasing_reports/generate_forBankRecon"  method="post" id="frm_bankRecon" name = "frm_bankRecon">
                                            <div class="row">
                                                            ...
                                                            <div class="col-md-8 text-left">
                                                                <div class="input-group">
                                                                    ...
                                                                    <div class="validation-Error">
                                                                        <span ng-show="frm_bankRecon.from_date.$dirty && frm_bankRecon.from_date.$error.required">
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <div class="col-md-8 text-left">
                                                                <div class="input-group">
                                                                    ...
                                                                    <!-- FOR ERRORS -->
                                                                    <div class="validation-Error">
                                                                        <span ng-show="frm_bankRecon.to_date.$dirty && frm_bankRecon.to_date.$error.required">
                                                                            <p class="error-display">This field is required.</p>
                                                                        </span>
                                                                    </div>
                                                                </div>
