                            ...
                            <div role="tabpanel" class="tab-pane active" id="payment">
                                <div class="row"> <!-- table wrapper  --> 
                                	<table class="table table-bordered" id="subsidiaryLedger_table" ng-controller="tableController">
                                        ...
                                        <tbody id = "subsidiaryLedger_tbody" ng-init = "get_rentReceivable(date_from, date_to)" >
                                	...
                                	<div class="col-md-12">
                                    	<a class="btn btn-default btn-medium pull-right" href="<?php echo base_url(); ?>index.php/leasing_reports/export_rentReceivable/{{date_from}}/{{date_to}}"  ><i class="fa fa-download"></i> Export Excel</a>
