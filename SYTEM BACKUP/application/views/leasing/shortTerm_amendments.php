        ...
        <div class="panel panel-default">
          <!-- Default panel contents -->
            ...
            <div class="panel-body">
                ...
                <div class="row">
                    <div class="col-md-12">
                        <a href="#" onclick="print('<?php echo base_url(); ?>index.php/leasing_reports/print_shortTerm_amendments')" class="btn btn-primary btn-lg pull-right"><i class="fa fa-print"></i> Print</a>
                    </div>
                </div>
            </div>
        </div>
