...
<div class="container" ng-controller="transactionController">
    <div class="well">
        <div class="panel panel-default">
            <div class="panel-heading panel-leasing"><i class="fa fa-pencil-square"></i> Invoicing</div>
                                        ...
                                        <form action="#"  method="post" id="frm_invoice" name = "frm_charges">
                                            ...
                                            <div class="row"> <!-- ROW FOR BUTTONS -->
                                                <div class = "col-md-12 text-right">
                                                    <button type = "button" onclick="check_invoiceTag()" ng-disabled = "frm_charges.$invalid" class = "btn btn-primary btn-medium"><i class = "fa fa-save"></i> Save Invoice</button>
                                                </div>
                                            </div>
                                        </form>
                                    </div>
    ...
    <div class="modal-dialog modal-md">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="modal-footer">
                    <a href="#" id="append_less30_basic_fixedPercentage" class="btn btn-primary"><i class="fa fa-save"></i> Append</a>
                    <button type="button" class="btn btn-danger" data-dismiss="modal"> <i class="fa fa-close"></i> Close</button>
                </div>
            </div><!-- /.modal-content -->
        </div><!-- /.modal-dialog -->
    ...
    <div class="modal-dialog modal-md">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="modal-footer">
                    <a href="#" id="append_less30_basic" class="btn btn-primary"><i class="fa fa-save"></i> Append</a>
                    <button type="button" class="btn btn-danger" data-dismiss="modal"> <i class="fa fa-close"></i> Close</button>
                </div>
            </div><!-- /.modal-content -->
        </div><!-- /.modal-dialog -->
    ...
    <div class="modal-dialog modal-xl">
        <form action="#" method="post" id="frm_less30_monthlyCharges"  name = "frm_less30_monthlyCharges" >
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    <a href="#" onclick="append_less30_monthlyCharges()" ng-disabled = "frm_less30_monthlyCharges.$invalid" class="btn btn-primary"><i class="fa fa-save"></i> Append</a>
                    <button type="button" class="btn btn-danger" data-dismiss="modal"> <i class="fa fa-close"></i> Close</button>
                </div>
            </div><!-- /.modal-content -->
        </form>
...
<div class="modal fade" id = "monthly_charges">
    <div class="modal-dialog modal-xl">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <a href="#" onclick="append_monthlyCharges()"  class="btn btn-primary"><i class="fa fa-save"></i> Append</a>
                <button type="button" class="btn btn-danger" data-dismiss="modal"> <i class="fa fa-close"></i> Close</button>
            </div>
        </div><!-- /.modal-content -->
    </div><!-- /.modal-dialog -->
    ...
    <div class="modal-dialog modal-sm">
        <div class="modal-content">
            ...
            <form action="#"  method="post" id="frm_tag" name = "frm_tag">
                ...
                <div class="modal-footer">
                    <button type="button" onclick="save_invoice('<?php echo base_url(); ?>index.php/leasing_transaction/save_invoice/')" class="btn btn-primary" data-dismiss="modal"> <i class="fa fa-save"></i> Proceed</button>
                </div>
            </form>
        </div><!-- /.modal-dialog -->
    </div><!-- /.modal -->
                                ...
                                <div class="col-md-12">
                                    <div class="row">
                                        <div class="col-md-4 pull-right">
                                            <button type = "button" ng-click = "evaluate_rental(tenant_primaryKey, rent_sale, basic_rental, is_incrementable)" class = "btn btn-info btn-medium pull-right"><i class = "fa fa-cog"></i> Evaluate</button>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="col-md-12">
                                    <div class="row" ng-hide = "!higher_rental">
                                        <div class="col-md-8 col-md-offset-2" >
                                            ...
                                            <div class="row">
                                                <div class="col-md-4 pull-right">
                                                    <button type = "button" id="append_fixedORPercentage" class = "btn btn-primary btn-medium pull-right"><i class = "fa fa-plus"></i> Append</button>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                        ...
                        <div class="col-md-12">
                            <div class="row">
                                ...
                                <div class="col-md-12">
                                    <div class="row">
                                        <div class="col-md-4 pull-right">
                                            <button type = "button" ng-click = "evaluate_rental(tenant_primaryKey, rent_sale, current_rental, is_incrementable)" class = "btn btn-info btn-medium pull-right"><i class = "fa fa-cog"></i> Evaluate</button>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="col-md-12">
                                    <div class="row" ng-hide = "!higher_rental">
                                        <div class="col-md-8 col-md-offset-2" >
                                            ...
                                            <div class="row">
                                                <div class="col-md-4 pull-right">
                                                    <button type = "button" id="append_less30_basic_fixedORPercentage" class = "btn btn-primary btn-medium pull-right"><i class = "fa fa-plus"></i> Append</button>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
    ...
    <div class="modal-dialog modal-md">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="modal-footer">
                    <a href="#" id="append_basicRental_manual" class="btn btn-primary"><i class="fa fa-save"></i> Append</a>
                    <button type="button" class="btn btn-danger" data-dismiss="modal"> <i class="fa fa-close"></i> Close</button>
                </div>
            </div><!-- /.modal-content -->
        </div><!-- /.modal-dialog -->
