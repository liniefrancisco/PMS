                        ...
                        <div class="tab-content ng-cloak">
                            <div role="tabpanel" class="tab-pane active" id="general_ledger">
                                <div class="row"> <!-- table wrapper  -->
                                    ...
                                    <table class="table table-bordered" ng-table = "tableParams" id="generalLedger_table"  ng-init="loadList('<?php echo base_url(); ?>index.php/leasing_reports/get_locationCodePerTenant')">
                                        ...
                                        <tbody id = "subsidiaryLedger_tbody">
                                            <tr class="ng-cloak" ng-repeat= "dt in data">
                                                ...
                                                <td title = "'Location Code'" sortable = "'location_code'">{{ dt.location_code }}</td>
                                                ...
                                                <td title = "'Contract Date'" sortable = "'contract_date'">{{ dt.contract_date }}</td>
                                            </tr>
                                        </tbody>
                                    ...
                                    <div class="col-md-12">
                                        <a style="margin-right: 10px" class="btn btn-default btn-medium pull-right" href="<?php echo base_url(); ?>index.php/leasing_reports/export_locationCodePerTenant" ><i class="fa fa-download"></i> Export CSV</a>
                                    </div>
                                </div>
                            </div>
