    ...
    <div class="container">
        <div class="well">
            <div class="panel panel-default">
                <div class="panel-heading panel-leasing"><i class="fa fa-pencil-square"></i> Contract Signing(Short Term)</div>
                <div class="panel-body">
                    ...
                    <?php foreach ($basic_data as $data): ?>
                    <form action="" method="post" onsubmit="add_stenant('<?php echo base_url(); ?>index.php/leasing_transaction/add_stenant'); return false;" enctype="multipart/form-data" id="frm_contract" name = "frm_contract">
                        ...
                        <div class="row">
                            <div class="col-md-12 text-right">
                                <button type = "submit" ng-disabled = "frm_contract.$invalid" class="btn btn-medium btn-primary"><i class = "fa fa-save"></i> Submit</button>
                                <a href="<?php echo base_url(); ?>index.php/leasing_transaction/lst_Sforcontract" class = "btn btn-medium btn-default"><i class = "fa fa-arrow-circle-left"></i> Back</a>
                            </div>
                        </div>
                    </form>
                    <?php endforeach ?>   
