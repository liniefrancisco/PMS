        ...
        <div class="panel panel-default">
          <!-- Default panel contents -->
            ...
            <div class="panel-body">
                        ...
                        <table class="table table-bordered" ng-controller="tableController" ng-init="loadList('<?php echo base_url(); ?>index.php/leasing_mstrfile/get_exhibit_rates')">
                            <thead>
                                <tr>
                                    ...
                                    <th ><a href="#" data-ng-click="sortField = 'rate_per_week'; reverse = !reverse">Rate Per Week</a></th>
                                    <th ><a href="#" data-ng-click="sortField = 'rate_per_month'; reverse = !reverse">Rate Per Month</a></th>
                ...
                <div class="row">
                    <div class="col-md-12">
                        <a href="#" onclick="print('<?php echo base_url(); ?>index.php/leasing_reports/print_shortTerm_leasableArea')" class="btn btn-primary btn-lg pull-right"><i class="fa fa-print"></i> Print</a>
                    </div>
                </div>
            </div>
        </div>
