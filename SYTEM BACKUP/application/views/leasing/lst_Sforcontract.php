    ...
    <div class="well">
        <div class="panel panel-default">
          <!-- Default panel contents -->
            <div class="panel-heading panel-leasing"><i class="fa fa-list"></i> Approved Short Term Prospects</div>
            <div class="panel-body">
                ...
                <div class="row">
                    <div class="col-md-12">
                        <table class="table table-bordered" ng-table = "tableParams" ng-init="loadList('<?php echo base_url(); ?>index.php/leasing_transaction/get_approveSprospect')">
                            ...
                            <tbody>
                                <tr class="ng-cloak" ng-repeat= "prospect in data">
                                    ...
                                    <td title = "'Approved Date'" sortable = "'approved_date'">{{ prospect.approved_date }}</td>
                                    <td title = "'Action'">
