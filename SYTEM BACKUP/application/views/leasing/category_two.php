        ...
        <div class="panel panel-default">
          <!-- Default panel contents -->
            ...
            <div class="panel-body">
                ...
                <div class="row">
                    <div class="col-md-12">
                        <table class="table table-bordered" ng-table="tableParams" ng-controller="tableController" ng-init="loadList('<?php echo base_url(); ?>index.php/leasing_mstrfile/get_category_two')">
                                    ...
                                    <td title = "'Action'">
                                        ...
                                        <div class="btn-group">
                                            ...
                                            <ul class="dropdown-menu">
                                                <li><a href="#" data-backdrop="static" data-keyboard="false" data-toggle="modal" data-target="#update_modal" ng-click="update('<?php echo base_url(); ?>index.php/leasing_mstrfile/get_categoryTwo_data/' + category.id); populate_categoryOne('<?php echo base_url(); ?>index.php/leasing_mstrfile/get_category_one')"> <i class = "fa fa-edit"></i> Update</a></li>
                                                <li><a href="#" data-toggle="modal" data-target="#confirmation_modal" ng-click="delete('<?php echo base_url(); ?>index.php/leasing_mstrfile/delete_categoryTwo/' + category.id)"> <i class = "fa fa-trash"></i> Delete</a></li>
                                            </ul>
                                        </div>
                                    </td>    
                                    <?php endif ?>
        ...
        <div class="modal-dialog modal-md">
            <div class="modal-content">
                ...
                <div class="modal-body" ng-repeat = "data in updateData">
                    <form action = "{{ 'update_categoryTwo/' + data.id }}" method="post" name = "frm_update" id = "frm_update">
                        <div class="row">
                            <div class="col-md-8 col-md-offset-2">
                                <div class="form-group">
                                    <label for="first_level"><i class = "fa fa-asterisk"></i>First Level Category</label>
                                    <select class="form-control" required ng-model="data.first_level" name = "first_level" id = "first_level">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="validation-Error">
                                        <span ng-show="frm_update.second_level.$dirty && frm_update.second_level.$error.required">
                                            <p class="error-display">This field is required.</p>
                                        </span>
                                        <span ng-show="frm_update.second_level.$dirty && frm_update.second_level.$error.minlength">
                                            <p class="error-display">Minimum of 3 characters</p>
                                        </span>
                                        <span ng-show="frm_update.second_level.$dirty && frm_update.second_level.$error.unique">
    ...
    <div class="modal fade" id = "add_data">
        <div class="modal-dialog modal-md">
            <div class="modal-content">
                ...
                <form action="<?php echo base_url(); ?>index.php/leasing_mstrfile/add_category_two" name="add_form" method="post">
                    <div class="modal-body">
                        <div class="row">
                            <div class="col-md-8 col-md-offset-2">
                                <div class="form-group">
                                    <label for="first_level"><i class = "fa fa-asterisk"></i>First Level Category</label>
                                    <select class="form-control" required ng-model="first_level" name = "first_level" id = "first_level">
                                ...
                                <div class="form-group">
                                    ...
                                    <input 
                                        ...
                                        name = "second_level"
                                        is-unique
                                        is-unique-api="../ctrl_validation/verify_category_two/"
                                        autocomplete="off" >
                                    <!-- FOR ERRORS -->
                                    <div class="validation-Error">
                                        <span ng-show="add_form.second_level.$dirty && add_form.second_level.$error.required">
                                            <p class="error-display">This field is required.</p>
                                        </span>
                                        <span ng-show="add_form.second_level.$dirty && add_form.second_level.$error.minlength">
                                            <p class="error-display">Minimum of 3 characters</p>
                                        </span>
                                        <span ng-show="add_form.second_level.$dirty && add_form.second_level.$error.unique">
                                            <p class="error-display">Data already exist.</p>
                                        </span>
                                    </div>  
                                </div>
