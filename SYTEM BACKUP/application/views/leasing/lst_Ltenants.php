    ...
    <div class="well">
        <div class="panel panel-default">
          <!-- Default panel contents -->
            <div class="panel-heading panel-leasing"><i class="fa fa-list"></i> Long Term Tenants </div>
                                        ...
                                        <div class="btn-group">
                                            ...
                                            <ul class="dropdown-menu">
                                                ...
                                                <?php if ($this->session->userdata('user_type') == 'Administrator'): ?>
                                                    <li>
                                                        <a
                                                            href="<?php echo base_url(); ?>index.php/leasing_transaction/setup_forOtherContract/{{tenant.prospect_id}}/"
