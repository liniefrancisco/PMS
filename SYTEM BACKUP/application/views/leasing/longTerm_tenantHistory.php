        ...
        <div class="panel panel-default">
          <!-- Default panel contents -->
            ...
            <div class="panel-body">
                ...
                <div class="row">
                    <div class="col-md-12">
                        <table class="table table-bordered" ng-table = "tableParams" ng-controller="tableController" ng-init="loadList('<?php echo base_url(); ?>index.php/Leasing_reports/get_longtermHistory')">
                            <tbody>
                                <tr class="ng-cloak" ng-repeat= "dt in data">
                                    ...
                                    <td title = "'Contact Person/Owner'" sortable = "'contact_person'">{{dt.contact_person}}</td>
                            ...
                            <table class="table table-bordered">
                                <thead>
                                    <tr>
                                        ...
                                        <th ><a href="#" data-ng-click="sortBy = 'contract_no'; reverse = !reverse">Contract No.</a></th>
                                        <th ><a href="#" data-ng-click="sortBy = 'location_code'; reverse = !reverse">Location Code</a></th>
                                        <th ><a href="#" data-ng-click="sortBy = 'slots'; reverse = !reverse">Slots</a></th>
                                        <th ><a href="#" data-ng-click="sortBy = 'floor_area'; reverse = !reverse">Area per SQ.</a></th>
                                        <th ><a href="#" data-ng-click="sortBy = 'rental_type'; reverse = !reverse">Rental Type</a></th>
                                        <th ><a href="#" data-ng-click="sortBy = 'rental_type'; reverse = !reverse">Rent %</a></th>
                                        <th ><a href="#" data-ng-click="sortBy = 'contract_date'; reverse = !reverse">Contract Date</a></th>
                                        <th ><a href="#" data-ng-click="sortBy = 'Baic Rent'; reverse = !reverse">Basic Rent</a></th>

                                    </tr>
                                </thead>
                                <tbody>
                                    <tr class="ng-cloak" ng-repeat= "data in dataList2 | filter:query2 | orderBy:sortBy:reverse | offset: currentPage2*itemsPerPage2 | limitTo: itemsPerPage2"   
                                        ng-show="dataList2.length!=0" >
                                        <td class="{{data.status=='Active' ? 'bg-success': ''}}">{{data.trade_name}} </td>
                                        <td class="{{data.status=='Active' ? 'bg-success': ''}}">{{data.contract_no}}</td>
                                        <td class="{{data.status=='Active' ? 'bg-success': ''}}">{{data.location_code}}</td>
                                        <td class="{{data.status=='Active' ? 'bg-success': ''}}">{{data.slots}}</td>
                                        <td class="{{data.status=='Active' ? 'bg-success': ''}}" align = "right">{{data.floor_area | currency : '' }}</td>
                                        <td class="{{data.status=='Active' ? 'bg-success': ''}}">{{data.rental_type}}</td>
                                        <td class="{{data.status=='Active' ? 'bg-success': ''}}" align = "right">{{data.rent_percentage | currency : ''}}%</td>
                                        <td class="{{data.status=='Active' ? 'bg-success': ''}}">{{data.contract_date}}</td>
                                        <td class="{{data.status=='Active' ? 'bg-success': ''}}" align = "right">{{data.basic_rental | currency : '&#8369;' }}</td>
                                    </tr>
