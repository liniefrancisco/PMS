                    ...
                    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                        <div class="well" ng-controller="tableController">
                            <div class="panel panel-default">
                                <div class="panel-heading panel-leasing"><i class="fa fa-newspaper-o"></i> CFS Remittance</div>
                                            ...
                                            <div class="tab-content ng-cloak">
                                                <div role="tabpanel" class="tab-pane active">
                                                    <div class="col-md-10 col-md-offset-3" style="padding-top: 2%;">
                                                        <div class="row">
                                                            <form action="" onSubmit="payment_report('<?php echo base_url() ?>index.php/Leasing_reports/generate_CFS_remittance'); return false"  method="post" id="frm_paymentReport" name = "frm_paymentReport">
                                                                <div class="row">
