                                            ...
                                            <div class="tab-content ng-cloak">
                                                <div role="tabpanel" class="tab-pane active" id="general_ledger">
                                                    <div class="row"> <!-- table wrapper  -->
                                                        ...
                                                        <table ng-table="tableParams" class="table"  ng-init="loadList('<?php echo base_url(); ?>index.php/leasing_transaction/get_generalLedger')">
                                                            <tbody>
                                                                <tr ng-repeat="dt in data">
                                                                    <td title="'Entry No.'" sortable="'id'">{{dt.id}}</td>
                                                                    <td title="'Trade Name'" sortable="'trade_name'">{{dt.trade_name}}</td>
                                                                    <td title="'Doc Type'" sortable="'doc_type'">{{dt.doc_type}}</td>
                                                                    ...
                                                                    <td title="'Credit'" sortable="'debit'">{{ dt.credit | currency : ''}}</td>
                                                                </tr>
                                                            </tbody>
