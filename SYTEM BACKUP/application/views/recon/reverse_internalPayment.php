                    ...
                    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                        <div class="well">
                            <div class="panel panel-default">
                                <div class="panel-heading panel-leasing"><i class="fa fa-external-link"></i> Reverse Internal Payment</div>
                                    ...
                                    <div class="col-md-12">
                                        <div class="row">
                                            ...
                                            <div class="tab-content ng-cloak">
                                                <form action="#" onsubmit="save_reverseInternalPayment('<?php echo base_url() ?>index.php/leasing_transaction/save_reverseInternalPayment'); return false" method="post" name = "frm_clearing" id = "frm_clearing">
                                                    <div role="tabpanel" class="tab-pane active" id="rr_clearing">
                                                            ...
                                                            <div class="col-md-10 col-md-offset-1">
                                                                <div class="row">
                                                                    ...
                                                                    <div class="col-md-6">
                                                                        ...
                                                                        <div class="row">
                                                                            <div class="form-group">
                                                                                <label for="ds_no" class="col-md-5 control-label text-right"><i class="fa fa-asterisk"></i>DS No./Check No.</label>
                                                                                <div class="col-md-7">
                                                                                    <input
                                                                                        type = "text"
                                                        ...
                                                        <div class="row">
                                                            <div class="col-md-12">
                                                                <table class="table table-bordered" id="payment_table">
                                                                    ...
                                                                    <tbody id="payment_tbody">
                                                                        <tr ng-repeat = "data in unclearedPayments" ng-if = "data.amount > 0">
                                                                            <td style = "display:none"><input type = "text" name = "id[]" ng-model = "data.id" /></td>
                                                                            <td><input type = "text" style = "display:none" name = "doc_type[]" ng-model = "data.document_type" /> {{data.document_type}}</td>
                                                                            <td><input type = "text" style = "display:none" name = "ref_no[]" ng-model = "data.ref_no" /> {{data.ref_no}}</td>
                                                                            <td><input type = "text" style = "display:none" name = "doc_no[]" ng-model = "data.doc_no" /> {{data.doc_no}}</td>
                                                                            <td><input type = "text" style = "display:none" name = "description[]" ng-model = "data.description" /><span ng-if = "data.status == 'RR Clearing'">Basic-{{trade_name}}</span> <span  ng-if="data.status != 'RR Clearing'">Other-{{trade_name}}</span></td>
                                                                            <td><input type = "text" style = "display:none" name = "posting_date[]" ng-model = "data.posting_date" /> {{data.posting_date}}</td>
                                                                            <td class="currency"><input type = "text" style = "display:none" name = "amount[]" ng-model = "data.amount" /> {{data.amount | currency : ''}}</td>
                                                                            <td align="center" width="5%"><a class = "btn-sm btn-danger" ng-click = "get_totalUncleared(data.amount)" onClick="deletefromPayment(this)"  href = "#"><i class = "fa fa-trash"></i></a></td>
                                                                        </tr>
                                                                    </tbody>
                                                                ...
                                                                <div class="row">
                                                                    <div class="col-md-12">
                                                                        <div class="pull-right"><b>Total Amount: <u>{{total_amount | currency : ''}}</u></b> <input type = "text" style = "display:none" name = "total_payable" ng-model = "total_amount"  /></div>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>
