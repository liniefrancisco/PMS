    ...
    , datepickerDirective = function datepickerDirective($window, $compile, $locale, $filter, $interpolate) {
      ...
      var linkingFunction = function linkingFunction($scope, element, attr) {
        ...
        var selector = attr.selector
          ...
          , theCalendar
          , defaultPrevButton = '<b class="datepicker-default-button"><i class="fa fa-angle-double-left"></i></b>'
          , defaultNextButton = '<b class="datepicker-default-button"><i class="fa fa-angle-double-right"></i></b>'
