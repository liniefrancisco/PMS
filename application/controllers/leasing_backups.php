        ...
        public function generate_ARreports()
        {
            ...
            if(!empty($data)){
                ...
                if($fileType === "textFile"){
                    ...
                    $file_name = "Other Charges $filter_date - " .$exp_batch_no. ".csv";
                }
            ...
            if(!empty($data)){
                ...
                foreach ($data as $result){
                    if ($result['gl_code'] == '10.10.01.03.16' || $result['gl_code'] == '10.10.01.06.05') {
                        $rows[] = array(
                            'SALES','LEASING',$line_no,
                            'CUSTOMER',$result['gl_code'],$posting_date,
                            'Invoice',$month,$doc_no,$result['gl_account'],'PHP',
                            $result['amount'],
                            $result['amount'],
                            '',
                            $result['amount'],
                ...
                if($type === 'textFile'){
                    ...
                    $file_name = "Basic Rent " . date('Y-m', strtotime($month)) . ".csv";
                }
        ...
        public function generate_paymentCollection(){
            ...
            if(!empty($entries)){
                ...
                if($fileType == 'excelFile'){
                    $file_name = "Payment Collection $post_date - " .$exp_batch_no. ".csv";
                }else{
