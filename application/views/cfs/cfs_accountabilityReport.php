<div class="container" id="transactionController" ng-controller="transactionController">
    <div class="well">
        <div class="panel panel-default">
            <div class="panel-heading" style="background-color:#125821; color:whitesmoke"><i
                    class="fa fa-pencil-square"></i> Accountability Report</div>
                        ...
                        <div class="tab-content ng-cloak">
                            <div role="tabpanel" class="tab-pane active" id="preop">
                                <div class="col-md-10 col-md-offset-3" style="padding-top: 4%;">
                                    <div class="row">
                                        <form action=""
                                            onSubmit="generate_accountabilityReport('<?php echo base_url(); ?>index.php/Leasing_reports/cfs_accountabilityReport');return false"
