...
<body id = "leasing_login" ng-controller="appController">
    <div class="jumbotron jumbotron_leasing" style="background-color:#125821">

    </div>
    <div class="container leasingLogin_form">
        <div class="row">
            <div class="col-ms-4 col-md-4 col-lg-3 col-centered">
                <div class="account-wall">
                    <img class="profile-img" src="<?php echo base_url(); ?>img/agc-leasing-logo.png" alt="">
                    <form class="form-signin" action="<?php echo base_url(); ?>index.php/ctrl_cfs/check_cfsLogin" method="post">
                        ...
                        <button class="btn btn-lg btn-primary btn-block" type="submit">
                            Log in</button>
                        <!-- <a href="#" class="pull-right need-help">CFS Login </a><span class="clearfix"></span> -->
