												...
												<div class="col-md-6">
													...
													<!-- <div class="row">
														<div class="form-group">
															<label for="receipt_no" class="col-md-5 control-label text-right"><i class="fa fa-asterisk"></i>{{tenant.tin !== '' ? 'OR No.' : 'OR No.'}}</label>
															<div class="col-md-7">
															...
															<div class="col-md-7">
																<!-- <div class="input-group">
																	...
																	<!-- <input
																		...
																		required
																		name = "receipt_no"
																		class = "form-control emphasize text-right"
																		is-unique
																		is-unique-api="../ctrl_validation/verify_receiptNo/"
																		ng-model="receipt_no"
																		autocomplete="off"> -->
													...
													<div class="row">
														<div class="form-group">
															<label for="account_num" class="col-md-5 control-label text-right">
																<i class="fa fa-asterisk" ng-if="tender_type == 'Check'"></i> Bank Code</label>
															<div class="col-md-7">
																   <select
																	   name="bank_code"
									...
									<div class="row">
										<div class="col-md-12">
											<button role = "submit" 
												...
												class="btn btn-large btn-primary pull-right  button-b">
