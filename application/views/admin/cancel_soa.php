            ...
            <div class="row mt">
                <div class="col-md-10 col-md-offset-1">
                    <div class = "panel panel-theme">
                        <div class="panel-heading"><i class="fa fa-pencil"></i> Cancel SOA Entry</div>
                                    ...
                                    <section id="unseen">
                                        <div class="form-panel">
                                            <form class="form-horizontal tasi-form" action="#" method="post" id = "frm_cancelSoa">
                                                ...
                                                <div class="form-group">
                                                    <label class="col-sm-3 control-label col-lg-3 col-md-offset-1" for="soa_no"><b>SOA No.</b></label>
                                                    <div class="col-lg-4">
                                                        <input type="text" required autocomplete="off" name = "soa_no" class="form-control" id="soa_no">
                                                    </div>
                                                </div>
                                                <br>
                                                <div class="form-group">
