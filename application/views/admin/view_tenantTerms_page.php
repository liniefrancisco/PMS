        ...
        <div class="row">
            <div class="col-md-12">
                <div class="form-group">
                    ...
                    <div class="col-lg-8">
                        <input type="text" value="<?php echo $value['tin']; ?>" autocomplete="off" readonly name = "tin"  class="form-control" id="tin">
                    </div>
                </div>
            </div>
        </div>
        <div class="row">
            <div class="col-md-12">
                <div class="form-group">
                    ...
                    <div class="col-lg-8">
                        <select class="form-control"   name = "tenant_type" readonly>
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="form-group">
                    ...
                    <div class="col-lg-8">
                        <select class="form-control" id = "rental_type" readonly  name = "rental_type" required>
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="form-group">
                            ...
                            <div class="col-lg-8">
                                <input type="text" readonly value="<?php echo $value['rent_percentage']; ?>" name = "rent_percentage" required class="form-control currency" id="rent_percentage">
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="form-group">
                    ...
                    <div class="col-lg-8">
                        <select class="form-control" id = "sales"  name = "sales" readonly>
                ...
                <div class="form-group">
                    ...
                    <div class="col-lg-1">
                        <?php if ($value['penalty_exempt'] == '1'): ?>
                            <input type="checkbox" id = "penalty_exempt" readonly checked name = "penalty_exempt" value = "1" checked data-toggle="toggle">
                        <?php else: ?>
                ...
                <div class="form-group">
                    ...
                    <div class="col-lg-1">
                        <?php if ($value['is_vat'] == TRUE): ?>
                            <input type="checkbox" id = "vatable" readonly checked name = "vatable" value = "Added" checked data-toggle="toggle">
                        <?php else: ?>
                            <input type="checkbox" id = "vatable" readonly name = "vatable" value = "Added"  data-toggle="toggle">
                        <?php endif ?>
                    </div>
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="form-group">
                    ...
                    <div class="col-lg-8">
                        <input type="text" value="<?php echo $value['vat_percentage']; ?>" readonly name = "vat_percentage" required class="form-control currency" id="vat_percentage">
                    </div>
                </div>
            </div>
        </div>
        <div class="row">
            <div class="col-md-12">
                <div class="form-group">
                    ...
                    <div class="col-lg-8">
                        <input type="text" value="<?php echo $value['wht_percentage']; ?>" readonly name = "wht_percentage" required class="form-control currency" id="wht_percentage">
                    </div>
                </div>
            </div>
        </div>
        <div class="row">
            <div class="col-md-12">
                <div class="form-group">
                    ...
                    <div class="col-lg-8">
                        <select class="form-control" id = "vat_agreement"  name = "vat_agreement" readonly>
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="form-group">
                    ...
                    <div class="col-lg-8">
                        <select class="form-control" readonly  name = "increment_percentage">
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="form-group">
                    ...
                    <div class="col-lg-8">
                        <select class="form-control"  required name = "increment_frequency" readonly>
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="form-group">
                    ...
                    <div class="col-lg-8">
                        <input type="text" autocomplete="off" readonly value = "<?php echo $value['opening_date']; ?>"  required name = "opening_date" required class="form-control" id="opening_date">
                    </div>
                </div>
            </div>
        </div>
        <div class="row">
            <div class="col-md-12">
                <div class="form-group">
                    ...
                    <div class="col-lg-8">
                        <input type="text" autocomplete="off" readonly value = "<?php echo $value['expiry_date']; ?>"  required name = "expiry_date" required class="form-control" id="expiry_date">
                    </div>
                </div>
            </div>
        </div>
