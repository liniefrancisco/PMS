                    ...
                    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                        <div class="well" ng-controller="tableController">
                            <div class="panel panel-default">
                                <div class="panel-heading panel-leasing"><i class="fa fa-newspaper-o"></i> Monthly RR/AR
                                    Summary</div>
                                            ...
                                            <div class="tab-content ng-cloak">
                                                <div role="tabpanel" class="tab-pane active">
                                                    <div class="col-md-10 col-md-offset-3" style="padding-top: 2%;">
                                                        <div class="row">
                                                            <form
                                                                action="<?php echo base_url() ?>index.php/Leasing_reports/generate_ar_ar_summary"
                                                                            ...
                                                                            <div class="form-group">
                                                                                ...
                                                                                <div class="col-md-8 text-left">
                                                                                    <select class="form-control"
                                                                                        ...
                                                                                        <option>External Tenants
                                                                                        </option>
                                                                                        <option>Internal Tenants
                                                                                        </option>
                                                                                    </select>
                                                                                    <!-- FOR ERRORS -->
                                                                                    <div class="validation-Error">
                                                                                        <span
                                                                                            ng-show="frm_summary.tenant_type.$dirty && frm_summary.tenant_type.$error.required">
