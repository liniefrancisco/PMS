            ...
            <div class="nav-container">
                <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                    <ul class="nav navbar-nav navbar-left">
                        <li><a href="<?php echo base_url(); ?>index.php/ctrl_recon/home"><i class="fa fa-home"></i> Home/Recon</a></li>
                        <li><a href="<?php echo base_url(); ?>index.php/ctrl_recon/unclosedPDC"><i class="fa fa-folder-open"></i> Unclosed PDC</a></li>
                        <li><a href="<?php echo base_url(); ?>index.php/ctrl_recon/record_internalPayment"><i class="fa fa-credit-card"></i> Record Internal Payment</a></li>
                        <li><a href="<?php echo base_url(); ?>index.php/ctrl_recon/reverse_internalPayment"><i class="fa fa-external-link"></i> Reverse Internal Payment</a></li>
                        <li><a href="<?php echo base_url(); ?>index.php/ctrl_recon/collection_reports"><i class="fa fa-external-link"></i>PDC Collection</a></li>
                    </ul>
                   <ul class="nav navbar-nav navbar-right">
                        <li class="dropdown">
                            ...
                            <ul class="dropdown-menu">
                                <li><a href="<?php echo base_url(); ?>index.php/ctrl_recon/logout"><i class="fa fa-power-off"></i> Logout</a></li>
                            </ul>
                        </li>
                    </ul>
                </div>
