    ...
    <div class="well" ng-controller="tableController">
        <div class="panel panel-default">
          ...
          <div class="panel-heading panel-leasing">
                <i class="fa fa-list"></i> Long Term Pending Contracts
                                            ...
                                            <ul class="dropdown-menu">
                                                <li>
                                                    <a
                                                        ...
                                                        <i class = "fa fa-eye"></i> Review Prospect
                                                    </a>
                                                </li>
                ...
                <div class="modal-body ng-cloak" ng-repeat = "detail in viewList">
                    <div class="row">
                                            ...
                                            <table class="table table-bordered">
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td><button class="btn btn-sm primary button-w" data-target="#image_viewer" data-toggle="modal" ng-click="getContractDoc(detail.tenant_id)">View Document</button></td>
                                                    </tr>
                                                    <tr>
                        ...
                        <div class="modal-footer">
                            <?php if ($this->session->userdata('user_type') == 'Store Manager' || $this->session->userdata('user_type') == 'Supervisor' || $this->session->userdata('user_type') == 'Coporate Leasing Supervisor'): ?>
                                            ...
                                            <button 
                                                    ...
                                                    href="#"
                                                    ng-click = "confirm('<?php echo base_url(); ?>index.php/leasing_transaction/post_lpendingContract/' + detail.id)"> 
                                                    <i class = "fa fa-save" style="color: green;"></i> Post
                                            </button>
                            <?php elseif ($this->session->userdata('user_type') == 'Legal'): ?>
                            <?php else: ?>
                                            ...
                                            <button 
                                                    ...
                                                    data-dismiss="modal" 
                                                    data-toggle="modal"
                                                    ng-click = "managers_key('<?php echo base_url(); ?>index.php/leasing_transaction/post_lpendingContract/' + detail.id)"
                                                    data-target="#manager_modal"> 
                                                    <i class = "fa fa-save" style="color: green;"></i> Post
                                            </button>
        ...
        <div class="modal-dialog modal-sm">
            <div class="modal-content">
                ...
                <form action="#"  method="post" id="frm_managerKey" name = "frm_managerKey">
                    ...
                    <div class="modal-footer">
                        <a href="#"  class="btn btn-primary button-b" data-dismiss="modal"> <i class="fa fa-key"></i> Submit</a>
