<div class="container" ng-controller="paymentCntrl" ng-init='getInitData(); clearPaymentData();
		tender_types = <?= $tender_types ?>; 
		<?= $this->session->userdata('cfs_logged_in') ? "getCcmCustomers()" : "" ?>'>
	<div class="well">
		<div class="panel panel-default">
			<div class="panel-heading <?= $this->session->userdata('cfs_logged_in') ? 'panel-cfs' : 'panel-leasing' ?>">
				<i class="fa fa-pencil-square"></i> Payment
			</div>
				...
				<div class="col-md-12">
					<div class="row">
						...
						<div class="tab-content ng-cloak">
							<form action="" ng-submit="savePayment($event)" method="post" name="frm_payment"
								id="frm_payment">
								<div role="tabpanel" class="tab-pane active" id="payment">
											...
											<div class="row">
												<div class="col-md-6">
													...
													<div class="row">
														<div class="form-group">
															...
															<div class="col-md-7">
																<input type="text" readonly ng-model="tenant.tenant_id"
																	id="tenant_id" name="tenant_id"
																	class="form-control">
																<input type="hidden" name="receipt_type"
																	value="{{tenant.tin !== '' ? 'OR' : 'AR'}}">
															</div>
														</div>
													</div>
													<div class="row">
														<div class="form-group">
															...
															<div class="col-md-7">
																<input type="text" ng-model="tenant.contract_no"
													...
													<div class="row">
														<div class="form-group">
															<label for="contract_no"
																class="col-md-5 control-label text-right"><i
																	class="fa fa-asterisk"></i>Tenant Address</label>
															<div class="col-md-7">
																<input type="text" ng-model="tenant.address" readonly
																	name="tenant_address" class="form-control">
															</div>
														</div>
													</div>
													<div class="row">
														<div class="form-group">
															...
															<div class="col-md-7">
																<input type="text" ng-model="tenant.corporate_name"
																	readonly name="corporate_name" class="form-control">
															</div>
														</div>
													</div>
												</div>
												<div class="col-md-6"> <!-- COL-MD-6 DIVIDER -->
													<div class="row">
														<div class="form-group">
															<label for="payment_date"
																class="col-md-5 control-label text-right">Payment
																Date</label>
															<div class="col-md-7">
																...
																<div class="validation-Error">
																	<span
																		ng-show="frm_payment.payment_date.$dirty && frm_payment.payment_date.$error.required">
													...
													<div class="row">
														<div class="form-group">
															<label for="soa_date"
																class="col-md-5 control-label text-right">SOA
																Date</label>
															<div class="col-md-7">
																<div class="input-group">
																	<div class="input-group-addon input-date"><strong><i
																	...
																	<datepicker date-format="yyyy-M-dd">
																		<input type="text" required
																			ng-disabled="!tenant" readonly
																			placeholder="Choose a date"
																			class="form-control" ng-model="pmt.soa_date"
																			id="soa_date" name="soa_date"
																			autocomplete="off"
																			ng-change="getSoaWithBalances(tenant.tenant_id, pmt.soa_date)">
																	</datepicker>
																</div>
																<!-- FOR ERRORS -->
																<div class="validation-Error">
																	<span
																		ng-show="frm_payment.soa_date.$dirty && frm_payment.soa_date.$error.required">
																		<p class="error-display">This field is required.
																		</p>
																	</span>
																</div>
													...
													<div class="row">
														<div class="form-group">
															<label for="soa_no"
																class="col-md-5 control-label text-right"><i
																	class="fa fa-asterisk"></i>SOA No.</label>
															<div class="col-md-7">
																<select name="soa_no" class="form-control"
																	style="font-weight: bold;" ng-model="pmt.soa"
																	ng-options="s as s.soa_no for s in pmt.soa_docs"
																	ng-change="getInvoicesBySoaNo(tenant.tenant_id, pmt.soa.soa_no)">
																</select>
																<input type="hidden" name="soa_no"
													...
													<div class="row">
														<div class="form-group">
															<label for="billing_period"
																class="col-md-5 control-label text-right"><i
																	class="fa fa-asterisk"></i>Billing Period</label>
															<div class="col-md-7">
																<input type="text" ng-value="pmt.soa.billing_period"
													...
													<div class="row">
														<div class="form-group">
															<label for="remarks"
																...
																<!-- <i class="fa fa-asterisk"></i> -->Remarks</label>
															<div class="col-md-7">
																<input type="text" ng-model="pmt.remarks" id="remarks"
													...
													<div class="row">
														<div class="form-group">
															<label for="total"
																class="col-md-5 control-label text-right">Total Payable
																Amount</label>
															<div class="col-md-7">
																<div class="input-group">
									...
									<div class="row" ng-if="payment_docs.length > 0">
										<div class="col-md-12">
											<div class="row">
												<div class="col-md-12">
											...
											<div class="row" ng-init="tender_typeCode = 1">
												<div class="col-md-10 col-md-offset-1">
													<div class="col-md-6 {{tender_typeCode != '2' ? '' : ''}}">
														<div class="row">
															<div class="form-group">
																<label for="tender_typeCode"
																	class="col-md-5 control-label text-right"><i
																		class="fa fa-asterisk"></i>Tender Type</label>
																<div class="col-md-7">
																	<select class="form-control"
																		ng-model="tender_typeCode" required
																		ng-options="t.id as t.desc  for t in tender_types"
																		ng-change="getTransactionNo(tender_typeCode)">
																	</select>
																	<input type="hidden" name="tender_typeCode"
																		ng-value="tender_typeCode">
																</div>
															</div>
														</div>

														<div class="row"
															ng-if="tender_typeCode != '11' && tender_typeCode != '12'">
															<div class="form-group">
																<label for="receipt_no"
																	class="col-md-5 control-label text-right"><i
																		class="fa fa-asterisk"></i>PS No.</label>
																<div class="col-md-7">
																	<!-- <div class="input-group"> -->
																	...
																	<!-- <input
																			...
																			autocomplete ="off"> -->
																	<input type="text" readonly
																		value="<?= $payment_docNo; ?>" id="receipt_no"
																		name="receipt_no" class="form-control">
																	<!-- </div> -->

																	<div class="validation-Error">
																		<span
																			ng-show="frm_payment.receipt_no.$dirty && frm_payment.receipt_no.$error.required">
																			<p class="error-display">This field is
																				required.</p>
																		</span>
																		<span
																			ng-show="frm_payment.receipt_no.$dirty && frm_payment.receipt_no.$error.unique">
																			<p class="error-display">Receipt No already
																				in use.</p>
																		</span>
																	</div>
																</div>
														...
														<div class="row" ng-if="tender_typeCode == '11'">
															<div class="form-group">
																<label for="receipt_no"
																	class="col-md-5 control-label text-right"><i
																		class="fa fa-asterisk"></i>Transaction
																	No.</label>
																<div class="col-md-7">
																	<input type="text" readonly name="receipt_no"
																		class="form-control emphasize currency"
																		ng-value="pmt.uft_no">
																</div>
															</div>
															...
															<div class="form-group">
																...
																<div class="col-md-7">
																	...
																	<input type="hidden" name="store_code"
																		ng-value="pmt.store.store_code">
																	<input type="hidden" name="store_name"
																		ng-value="pmt.store.store_name">
																</div>
															</div>
														</div>
														<div class="row"
															ng-if="tender_typeCode != '1' && tender_typeCode != '11' && tender_typeCode != '12' && tender_typeCode != '4'">
															<div class="form-group">
																<label for="tender_typeDesc"
																	class="col-md-5 control-label text-right"><i
																		class="fa fa-asterisk"></i>Supporting
																	Document</label>
																<div class="col-md-7">
		...
		<div class="modal-dialog" style="width: 80%;">
			...
			<div class="modal-content">
					...
					<table class="table table-sm table-border">
						...
						<tbody>
							<tr ng-repeat="inv in invoices | orderBy:'org_sequence':false | orderBy:'sequence':false"
								...
								<td align="right">{{inv.balance | currency:''}}</td>
								<td align="center">
									<input type="checkbox" style="zoom: 1.5" ng-model="inv.selected"
										ng-change="selectInvoice(inv)">
								</td>
							</tr>
						</tbody>
					</table>
				...
				<div class="modal-footer">
					<button type="button" class="btn btn-primary button-b" ng-click="applySelectedInvoices()"
						...
						<div class="row">
							<div class="col-md-12">
								<table class="table table-bordered">
									<thead>
										<tr>
											<th><a href="#" data-ng-click="sortBy = 'tenant_id'; reverse = !reverse">Tenant
													ID</a></th>
											<th><a href="#" data-ng-click="sortBy = 'trade_name'; reverse = !reverse">Trade
													Name</a></th>
											<th><a href="#" data-ng-click="sortBy = 'store_name'; reverse = !reverse">Store
													Location</a></th>
										...
										<tr class="ng-cloak" ng-show="dataList2.length!=0"
											...
											<td align="right">
												...
												<div class="btn-group" style="width:70% !important">
													<button type="button" style="width:70% !important"
														ng-click="generate_paymentCredentials(data.trade_name, tenancy_type); pmt.trade_name =  data.trade_name;"
														class="btn btn-xs btn-primary" data-dismiss="modal">Select</button>
												</div>
											</td>
										</tr>
										<tr class="ng-cloak"
