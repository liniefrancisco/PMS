                        ...
                        <form action=""  method="post"   enctype="multipart/form-data" id="frm_contract" name = "frm_contract">
                            <div class="col-md-12">
                                <div class="alert alert-warning alert-dismissible rounded-0" role="alert">
                                    ...
                                    <strong>Note!</strong> Please upload <b>Contract Documents</b> to proceed. Please name the documents to: 
                                                           <br>If new contract (<i>Tenant ID-new_contract-Number</i>) Example: <b>ICM-LT000001-new_contract-1.jpg</b>
                                                           <br>If renewed contract (<i>Tenant ID-renew_contract-Number</i>) Example: <b>ICM-LT000001-renew_contract-1.jpg</b>
                                </div>
                                <div class="row">
                                    <!-- Nav tabs -->
                                    <ul class="nav nav-tabs" role="tablist">
                                        ...
                                        <li role="presentation"><a href="#Attachment" aria-controls="Attachment" role="tab" data-toggle="tab"><i class = "fa fa-asterisk"></i> Attachment</a></li>
                                    </ul>
                                    <!-- Tab panes -->
                                    <div class="tab-content">
                                            ...
                                            <div class="col-md-12">
                                                <div class="row">
                                                    <div class="col-md-6">
                                                        ...
                                                        <div class="row" >
                                                            <div class="form-group">
                                                                <label for="tin_status" class="col-md-4 control-label text-right"><i class = "fa fa-asterisk"></i>TIN Status</label>
                                                                <div class="col-md-8">
                                                                    <select
                                                                        name = "tin_status"
                                                                        id="tin_status"
                                                        ...
                                                        <div class="row" ng-if="tin_status === 'With TIN'">
                                                            <div class="form-group">
                                                                ...
                                                                <div class="col-md-8">
                                                                    <input
                                                                        ...
                                                                        <div class="validation-Error">
                                                                            <span ng-show="frm_contract.tin.$dirty && frm_contract.tin.$error.required">
                                                        ...
                                                        <div class="row" ng-if="tin_status === 'On Process'">
                                                            <div class="form-group">
                                                                <label for="tin" class="col-md-4 control-label text-right"><i class = "fa fa-asterisk"></i>TIN</label>
                                                                <div class="col-md-8">
                                                                    <input
                                                        ...
                                                        <div class="row" ng-if="tin_status === 'No TIN'">
                                                            <div class="form-group">
                                                                <label for="tin" class="col-md-4 control-label text-right"><i class = "fa fa-asterisk"></i>TIN</label>
                                                                <div class="col-md-8">
                                                                    <input
                                                        ...
                                                        <div class="row">
                                                            <div class="form-group">
                                                                ...
                                                                <div class="col-md-8">
                                                                    <div class = "input-group">
                                                                        <div class="input-group-addon input-date"><strong><i class="fa fa-calendar"></i></strong></div>
                                                                        <input type="hidden" name="expiry_date" ng-value="expiry_date" required="">
                                                                        <datepicker date-format="yyyy-M-dd">
                                                                            <input
                                                                                type = "text"
                                                                                class = "form-control"
                                                    ...
                                                    <div class="col-md-6">
                                                        ...
                                                        <div class="row">
                                                            <div class="form-group">
                                                                ...
                                                                <div class="col-md-8">
                                                                    <input type = "text" id = "location_code" readonly value="<?php echo $location_code; ?>" name = "location_code"  class="form-control" />
                                                    ...
                                                    <div class="panel panel-default">
                                                        ...
                                                        <div class="panel-body">
                                                            <table class="table table-bordered"  ng-init="get_discounts('<?php echo base_url(); ?>index.php/leasing_mstrfile/get_tenant_type'); loadList('<?php echo base_url(); ?>index.php/leasing_transaction/get_monthly_charges/')">
                                                                ...
                                                                <tbody>
                                                                    <tr class="ng-cloak" ng-repeat= "type in discountList">
                                                                        <td>
                                                                    ...
                                                                    <tr class="ng-cloak" ng-show="!discountList.length && !isLoading">
                                        ...
                                        <div role="tabpanel" class="tab-pane" id="Attachment">
                                            <div class="col-md-10 col-md-offset-1">
                                                <div class="panel panel-default">
                                                    <div class="panel-heading"><i class="fa fa-paperclip"></i> <i class = "fa fa-asterisk"></i> Contract Document</div>
                                                    <div class="panel-body">
                                                        <div class="col-md-12">
                                                            <input id="contract_docs" name = "contract_docs[]" ng-model = "contract_docs" valid-file type="file" multiple="multiple" required>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                                                ...
                                                                <table class="table table-bordered" ng-table = "tableParams">
                                                                    <tbody>
                                                                        <tr ng-repeat = "charge in data">
                                                                            ...
                                                                            <td align="right"> <input class = "form-control currency" ui-number-mask="2" type = "text" ng-model = "charge.unit_price"></td>
                                                                        </tr>
                                                                    </tbody>
                                                                </table>
                                                            </div>
                            ...
                            <div class="row">
                                <div class="col-md-12 text-right">
                                    <?php if ($this->session->userdata('user_type') == 'Administrator' || $this->session->userdata('user_type') == 'Store Manager' || $this->session->userdata('user_type') == 'Supervisor' || $this->session->userdata('user_type') == 'Corporate Leasing Supervisor'): ?>
                                            <button type = "button" onclick="add_tenant('<?php echo base_url(); ?>index.php/leasing_transaction/add_tenant/');" ng-disabled = "frm_contract.$invalid" class="btn btn-medium btn-primary button-b"><i class = "fa fa-save"></i> Submit</button>
                                    <?php else: ?>
                                            <button type = "button" data-toggle="modal" data-target="#tagAs_modal" ng-disabled = "frm_contract.$invalid" class="btn btn-medium btn-primary button-b"><i class = "fa fa-save"></i> Submit</button>
                                    <?php endif ?>
            ...
            <div class="modal-content">
                ...
                <form action="#"  method="post" id="frm_managerKey" name = "frm_managerKey">
                    ...
                    <div class="modal-footer">
                        <button type="button" onclick="add_tenant('<?php echo base_url(); ?>index.php/leasing_transaction/add_tenant/');" class="btn btn-primary button-b" data-dismiss="modal"> <i class="fa fa-key"></i> Submit</button>
        ...
        <div class="modal-dialog modal-sm">
            <div class="modal-content">
                ...
                <form action="#"  method="post" id="frm_tag" name = "frm_tag">
                                ...
                                <div class="row">
                                    <div class="col-md-8 col-md-offset-3">
                                        <div class="radio radio-info radio-inline">
                                            <input type="radio" id="Pending" value="Pending" name="tag" checked>
                                            <label for="Draft"> Pending </label>
                                        </div>
                                        <div class="radio radio-info radio-inline">
                    ...
                    <div class="modal-footer">
                        <button type="button" onclick="checkTag('<?php echo base_url(); ?>index.php/leasing_transaction/pending_contract/')" class="btn btn-primary button-b" data-dismiss="modal"> <i class="fa fa-save"></i> Proceed</button>
                    </div>
                </form>
            </div><!-- /.modal-dialog -->
        </div><!-- /.modal -->
