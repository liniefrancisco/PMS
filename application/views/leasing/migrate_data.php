                        ...
                        <div class="tab-content ng-cloak">
                            <div role="tabpanel" class="tab-pane active" id="preop">
                                <div class="col-md-10 col-md-offset-3" style="padding-top: 4%;">
                                    <div class="row">
                                        <form action=""
                                            onSubmit="migrate_bigBal('<?php echo base_url() ?>index.php/Leasing_reports/migrate_bigBal');return false"
                                            enctype='multipart/form-data' method="post" id="frm_migrate_bigBal"
                                            name="frm_receivableSummary">
                                            <div class="row">
                                                        ...
                                                        <div class="form-group">
                                                            <label for="as_of_date"
                                                                class="col-md-4 control-label text-right"><i
                                                                    class="fa fa-asterisk"></i>Text File</label>
                                            ...
                                            <div class="col-md-6">
                                                <div class="row pull-right" style="padding-right: 13%">
                                                    <div class="col-md-12">
                                                        <button type="submit" ng-disabled="frm_migrate_bigBal.$invalid"
                                                            class="btn btn-primary btn-lg button-vl"><i
                                                                class="fa fa-doc"></i> Migrate Data</button>
                                                    </div>
                                                </div>
                                            </div>
                                        </form>
