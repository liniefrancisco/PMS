<div class="container">
    <div class="well">
        <div class="panel panel-default">
            ...
            <div class="panel-heading panel-leasing"><i class="fa fa-list"></i> Revoked Short Term Prospects</div>
                ...
                <div class="row">
                    <div class="col-md-12">
                        <table class="table table-bordered" ng-table="tableParams" ng-controller="tableController"
                            ng-init="loadList('<?php echo base_url(); ?>index.php/leasing_archive/get_deniedSprospect')">
                                    ...
                                    <div class="row">
                                            ...
                                            <div class="thumbnail">
                                                ...
                                                <div class="caption">
                                                    <p><a href="#" data-toggle="modal" data-target="#carousel_modal"
                                                            ng-click="get_img('<?php echo base_url(); ?>index.php/leasing_transaction/get_proposal/' + data.id, '<?php echo base_url(); ?>assets/exhibitor_attachements/')"
                                        ...
                                        <div class="col-sm-6 col-md-4">
                                            ...
                                            <div class="thumbnail">
                                                ...
                                                <div class="caption">
                                                    <p><a href="#" data-toggle="modal" data-target="#carousel_modal"
                                                            ng-click="get_img('<?php echo base_url(); ?>index.php/leasing_transaction/get_excomprof/' + data.id, '<?php echo base_url(); ?>assets/exhibitor_attachements/')"
                                                            class="btn btn-primary btn-block" role="button"><i
                                                                class="glyphicon glyphicon-zoom-in"></i> View</a> </p>
                                                </div>
                                            </div>
                                        ...
                                        <div class="col-sm-6 col-md-4">
                                            ...
                                            <div class="thumbnail">
                                                <img src="<?php echo base_url(); ?>img/Folder-icon.png"
                                                    alt="Booth Layout" style="height:150px;">
                                                <div class="caption">
                                                    <p><a href="#" data-toggle="modal" data-target="#carousel_modal"
                                                            ng-click="get_img('<?php echo base_url(); ?>index.php/leasing_transaction/get_boothlayout/' + data.id, '<?php echo base_url(); ?>assets/exhibitor_attachements/')"
                                                            class="btn btn-primary btn-block" role="button"><i
                                                                class="glyphicon glyphicon-zoom-in"></i> View</a> </p>
                                                </div>
                                            </div>
                                        ...
                                        <div class="col-sm-6 col-md-4 col-md-offset-2">
                                            ...
                                            <div class="thumbnail">
                                                <img src="<?php echo base_url(); ?>img/Folder-icon.png"
                                                    alt="Booth Perpspective" style="height:150px;">
                                                <div class="caption">
                                                    <p><a href="#" data-toggle="modal" data-target="#carousel_modal"
                                                            ng-click="get_img('<?php echo base_url(); ?>index.php/leasing_transaction/get_experspective/' + data.id, '<?php echo base_url(); ?>assets/exhibitor_attachements/')"
                                                            class="btn btn-primary btn-block" role="button"><i
                                                                class="glyphicon glyphicon-zoom-in"></i> View</a> </p>
                                                </div>
                                            </div>
                                        ...
                                        <div class="col-sm-6 col-md-4">
                                            ...
                                            <div class="thumbnail">
                                                ...
                                                <div class="caption">
                                                    <p><a href="#" data-toggle="modal" data-target="#carousel_modal"
                                                            ng-click="get_img('<?php echo base_url(); ?>index.php/leasing_transaction/get_exdti_busireg/' + data.id, '<?php echo base_url(); ?>assets/exhibitor_attachements/')"
                                                            class="btn btn-primary btn-block" role="button"><i
                                                                class="glyphicon glyphicon-zoom-in"></i> View</a> </p>
                                                </div>
                                            </div>
