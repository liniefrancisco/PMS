                ...
                <div class="row">
                    <div class="col-md-12">
                        <table class="table table-bordered" ng-table="tableParams" ng-controller="tableController"
                            ng-init="loadList('<?php echo base_url(); ?>index.php/leasing_mstrfile/get_areaClassification')">
                            <tbody>
                                <tr class="ng-cloak" ng-repeat="dt in data">
                                    <td title="'Area Classification'" sortable="'classification'">{{ dt.classification
                                        }}</td>
                                            ...
                                            <div class="btn-group">
                                                ...
                                                <ul class="dropdown-menu">
                                                    <li><a href="#" data-backdrop="static" data-keyboard="false"
                                                            ...
                                                            ng-click="update('<?php echo base_url(); ?>index.php/leasing_mstrfile/get_areaClassification_data/' + dt.id)">
                                                            <i class="fa fa-edit"></i> Update</a></li>
                                                    <li><a href="#" data-toggle="modal" data-target="#confirmation_modal"
                                                            ng-click="delete('<?php echo base_url(); ?>index.php/leasing_mstrfile/delete_areaClassification/' + dt.id)">
    ...
    <div class="modal fade" id="add_data">
        <div class="modal-dialog modal-md">
            <div class="modal-content">
                ...
                <form action="<?php echo base_url(); ?>index.php/leasing_mstrfile/add_areaClassification"
                    name="add_form" method="post">
                    <div class="modal-body">
                        <div class="row">
                            <div class="col-md-10 ">
                                <div class="row">
                                    <div class="form-group">
                                        <label for="classification" class="col-md-4 control-label text-right"><i
                                                class="fa fa-asterisk"></i>Classification</label>
                                        <div class="col-md-8">
                                            <input type="text" required class="form-control" ng-model="classification"
                                                id="classification" name="classification" is-unique
                                                is-unique-api="../ctrl_validation/verify_areaClassification/"
                                                autocomplete="off">
                                            <!-- FOR ERRORS -->
                                            <div class="validation-Error">
                                                <span
                                                    ng-show="add_form.classification.$dirty && add_form.classification.$error.required">
                                                    <p class="error-display">This field is required.</p>
                                                </span>
                                                <span
                                                    ng-show="add_form.classification.$dirty && add_form.classification.$error.unique">
        ...
        <div class="modal-dialog modal-md">
            <div class="modal-content">
                ...
                <div class="modal-body" ng-repeat="data in updateData">
                    <form action="{{ 'update_areaClassification/' + data.id }}" method="post" name="frm_update"
                        id="frm_update">
                        <div class="row">
                            <div class="col-md-10">
                                <div class="row">
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-8">
                                            <input type="text" required class="form-control"
                                                ng-model="data.classification" id="classification" name="classification"
                                                is-unique-update is-unique-id="{{data.id}}"
                                                is-unique-api="../ctrl_validation/verify_areaClassification_update/">
                                            <!-- FOR ERRORS -->
                                            <div class="validation-Error">
                                                <span
                                                    ng-show="frm_update.classification.$dirty && frm_update.classification.$error.required">
                                                    <p class="error-display">This field is required.</p>
                                                </span>
                                                <span
                                                    ng-show="frm_update.classification.$dirty && frm_update.classification.$error.minlength">
                                                    <p class="error-display">Minimum of 5 characters</p>
                                                </span>
                                                <span
                                                    ng-show="frm_update.classification.$dirty && frm_update.classification.$error.unique">
                                                    <p class="error-display">Data already exist.</p>
                                                </span>
                                            </div>
                                        </div>
