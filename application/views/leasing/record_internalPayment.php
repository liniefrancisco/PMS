<div class="container" ng-controller = "transactionController">
	<div class="well">
		<div class="panel panel-default">
			<div class="panel-heading panel-leasing"><i class="fa fa-registered"></i> Record Internal Payments</div>
						...
						<div class="tab-content ng-cloak">
							<form action="#" onsubmit="save_internalPayment('<?php echo base_url() ?>index.php/leasing_transaction/save_internalPayment'); return false" method="post" name = "frm_recordInternalPayment" id = "frm_recordInternalPayment">
								<div role="tabpanel" class="tab-pane active" id="rr_clearing">
									...
									<div class="row">
										<div class="col-md-12">
											<button role = "submit" ng-disabled = "frm_recordInternalPayment.$invalid" class="btn btn-large btn-primary col-md-1 col-md-offset-10 button-vl"><i class="fa fa-save"></i> Submit</button>
										</div>
									</div>
								</div>
							</form>
