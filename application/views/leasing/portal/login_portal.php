...
<body id = "leasing_login" ng-controller="appController">
    ...
    <div class="container leasingLogin_form">
        <div class="row">
            <div class="col-lg-3 col-md-4 col-xs-4 col-centered">
                <div class="account-wall">
                    <img class="profile-img" src="<?php echo base_url(); ?>img/AGC-Leasing-portal.png"alt="">
                    <form class="form-signin" action="<?php echo base_url(); ?>index.php/portal/check_login" method="post">
                        ...
                        <button class="btn btn-lg button-orange btn-warning btn-block" type="submit">
                            Log in</button>
