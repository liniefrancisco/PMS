                ...
                <div class="col-md-12">
                    <div class="row">
                        <ul class="nav nav-tabs" role="tablist">
                            <li role="presentation" class="active"><a href="#" aria-controls="receipts_audit" role="tab"
                        ...
                        <div class="tab-content ng-cloak">
                            <div role="tabpanel" class="tab-pane active" id="preop">
                                <div class="col-md-10 col-md-offset-3" style="padding-top: 4%;">
                                    <div class="row">
                                        <form
                                            action="<?php echo base_url() ?>index.php/leasing_reports/generate_receiptsAudit"
                                            method="post" id="frm_receiptsAudit" name="frm_receiptsAudit">
                                            <div class="row">
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <div class="col-md-8 text-left">
                                                                ...
                                                                <div class="validation-Error">
                                                                    <span
                                                                        ng-show="frm_receiptsAudit.month.$dirty && frm_receiptsAudit.month.$error.required">
                                            ...
                                            <div class="col-md-6">
                                                <div class="row pull-right" style="padding-right: 13%">
                                                    <div class="col-md-12">
                                                        <button type="submit" ng-disabled="frm_receiptsAudit.$invalid"
