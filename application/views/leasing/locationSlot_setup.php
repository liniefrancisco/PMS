                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-8">
                                                <input
                                                    ...
                                                    autocomplete="off" 
                                                    is-unique
                                                    is-unique-api="../ctrl_validation/verify_slot/{{store_name}}/">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-8">
                                                <input
                                                    ...
                                                    is-unique-api="../ctrl_validation/verify_slotUpdate/{{data.store_name}}/">
        ...
        <div class="modal-content">
            ...
            <form action="#"  method="post" id="frm_managerKey" name = "frm_managerKey">
                ...
                <div class="modal-footer">
                    ...
                    <button type="button" class="btn btn-alert button-r" data-dismiss="modal"> <i class="fa fa-close"></i> Close</button>
                </div>
            </form>
        </div><!-- /.modal-dialog -->
    </div><!-- /.modal -->
