				...
				<div class="row">
					<div class="col-md-12">
						<table class="table table-bordered" ng-table="tableParams" ng-controller="tableController"
							ng-init="loadList('<?php echo base_url(); ?>index.php/leasing_transaction/get_draftInvoice')">
							<tbody>
								<tr class="ng-cloak" ng-repeat="dt in data">
									...
									<td title="'Description'" sortable="'charges_type'">
										<span
											ng-if="data.charges_type == 'Other'">{{dt.charges_type}}-{{dt.trade_name}}</span>
									...
									<td title="'Action'" align="center">
										...
										<div class="btn-group">
											...
											<ul class="dropdown-menu">
												...
												<li><a
														href="<?php echo base_url(); ?>index.php/leasing_transaction/update_invoicePage/{{dt.tenant_id}}/{{dt.doc_no}}">
