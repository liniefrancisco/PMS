<div class="container" ng-controller="transactionController">
	<div class="well">
		<div class="panel panel-default">
			<div class="panel-heading panel-leasing"><i class="fa fa-registered"></i> Identified Fund Transfer/OTC
				Payments</div>
				...
				<div class="col-md-12">
					<div class="row">
						...
						<div class="tab-content ng-cloak">
							<form action="#" onsubmit="save_reg_fundTransfer(); return false" method="post"
								name="frm_clearing" id="frm_clearing">
														...
														<div class="form-group">
															...
															<div class="col-md-7">
																...
																<div class="validation-Error">
																	<span
																		ng-show="frm_clearing.receipt_no.$dirty && frm_clearing.receipt_no.$error.required">
																		<p class="error-display">This field is required.
																		</p>
																	</span>
																	<span
																		ng-show="frm_clearing.receipt_no.$dirty && frm_clearing.receipt_no.$error.unique">
																...
																<div class="input-group">
																	...
																	<span class="input-group-btn">
																		<button class="btn btn-info" type="button"
																			ng-click="get_unclearedPayment(dirty.value)"><i
												...
												<div class="col-md-6">
													...
													<div class="row">
														<div class="form-group">
															<label for="deposit_slip"
																class="col-md-5 control-label text-right"><i
																	class="fa fa-asterisk"></i>Deposit Slip</label>
															<div class="col-md-7">
																<input type="file" id="deposit_slip" name="deposit_slip"
													...
													<div class="row">
														<div class="form-group">
															<label for="ds_no"
																class="col-md-5 control-label text-right"><i
																	class="fa fa-asterisk"></i>Deposit Slip No.</label>
															<div class="col-md-7">
																<input type="text" ng-model="ds_no" id="ds_no" required
																	name="ds_no" class="form-control">
															</div>
														</div>
													</div>
													<div class="row">
									...
									<div class="row">
										<div class="col-md-12">
												...
												<tbody id="payment_tbody">
													<tr ng-repeat="data in unclearedPayments" ng-if="data.amount > 0"
														...
														<td ng-if="data.selected" style="display: none;">
															<input type="hidden" name="ufts[{{$index}}][id]"
																ng-value="data.id" />
															<input type="hidden" name="ufts[{{$index}}][document_type]"
																ng-value="data.document_type" />
															<input type="hidden" name="ufts[{{$index}}][doc_no]"
																ng-value="data.doc_no" />
															<input type="hidden" name="ufts[{{$index}}][cas_doc_no]"
																ng-value="data.cas_doc_no" />
															<input type="hidden" name="ufts[{{$index}}][ref_no]"
																ng-value="data.ref_no" />
															<input type="hidden" name="ufts[{{$index}}][ft_ref]"
																ng-value="data.ft_ref" />
															<input type="hidden" name="ufts[{{$index}}][gl_accountID]"
																ng-value="data.gl_accountID" />
															<input type="hidden" name="ufts[{{$index}}][status]"
																ng-value="data.status" />
															<input type="hidden" name="ufts[{{$index}}][posting_date]"
																ng-value="data.posting_date" />
															<input type="hidden" name="ufts[{{$index}}][due_date]"
																ng-value="data.due_date" />
															<input type="hidden" name="ufts[{{$index}}][amount]"
																ng-value="data.amount" />
														</td>
														...
														<td align="center" width="5%">
															<input style="zoom: 1.5" type="checkbox"
											...
											<div class="row" ng-if="unclearedPayments">
												<div class="col-md-12">
													<div class="pull-right"><b>Total Amount:
															<u>{{selectedIPTotal(unclearedPayments) | currency :
																''}}</u></b>
														<input type="hidden" name="total_payable"
															ng-value="selectedIPTotal(unclearedPayments)" />
													</div>
												</div>
											</div>
										</div>
