                        ...
                        <div class="tab-content ng-cloak">
                            <div role="tabpanel" class="tab-pane active" id="preop">
                                <div class="col-md-10 col-md-offset-3" style="padding-top: 4%;">
                                    <div class="row">
                                        <form action="<?= base_url() ?>index.php/leasing_reports/generate_paymentCollection_internal"  method="post" target="_blank" id="frm_collectionReports" name = "frm_collectionReports">
                                            <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                <div class="row pull-right" style="padding-right: 13%">
                                                    <div class = "col-md-12">
                                                        <button type = "submit" ng-disabled = "frm_collectionReports.$invalid" class = "btn btn-primary btn-lg button-vl"><i class = "fa fa-doc"></i> Generate Report</button>
                                                    </div>
                                                </div>
                                            </div>
                                        </form>
