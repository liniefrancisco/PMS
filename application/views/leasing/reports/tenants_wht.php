                    ...
                    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                        <div class="well">
                            <div class="panel panel-default">
                                <div class="panel-heading panel-leasing"><i class="fa fa-edit"></i> Tenants with
                                    Witholding Tax</div>
                                                ...
                                                <div role="tabpanel" class="tab-pane active" id="payment">
                                                    <div class="row">
                                                        <div class="col-md-10 col-md-offset-1">
                                                            <form ng-submit="generateTenantWithWHT($event)"
                                                    ...
                                                    <div class="row" ng-show="tenantwhttable"> <!-- table wrapper  -->
                                                        ...
                                                        <div class="col-md-12" ng-if="tenantwhttable">
                                                            <a class="btn btn-default btn-medium pull-right button-w"
                                                                href="<?php echo base_url(); ?>index.php/leasing_reports/export_tenantwht/{{tenancy_type}}/{{store}}"><i
