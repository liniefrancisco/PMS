						...
						<div class="tab-content ng-cloak">
							<form action="#" onsubmit="save_reg_fundTransfer(); return false" method="post" name = "frm_clearing" id = "frm_clearing">
								<div role="tabpanel" class="tab-pane active" id="rr_clearing">
												...
												<div class="col-md-6">
													<div class="row">
														<div class="form-group">
															<label for="receipt_no" class="col-md-5 control-label text-right"><i class="fa fa-asterisk"></i>Transaction Number</label>
															<div class="col-md-7">
									...
									<div class="row">
										<div class="col-md-12">
											<button role = "submit" ng-disabled = "frm_clearing.$invalid" class="btn btn-large btn-primary col-md-1 col-md-offset-10 button-b"><i class="fa fa-save"></i> Submit</button>
										</div>
									</div>
								</div>
							</form>
