                    ...
                    <div class="col-md-10 col-md-offset-1">
                        ...
                        <div class="alert alert-warning alert-dismissible rounded-0" role="alert">
                                ...
                                <strong>Note!</strong> Please upload <b>Contract Documents</b> to proceed. Please name the documents to: 
                                                       <br>If amended contract (<i>Tenant ID-amended_contract-Number</i>) Example: <b>ICM-LT000001-amended_contract-1.jpg</b>
                                                       <br>If renew contract (<i>Tenant ID-renew_contract-Number</i>) Example: <b>ICM-LT000001-renew_contract-1.jpg</b>
                        </div>
                        <ul class="nav nav-tabs" role="tablist"> 
                            ...
                            <li role="presentation" class=""><a href="#amend_attachments" aria-controls="amend_attachments" role="tab" data-toggle="tab">Attachments (Required)</a></li>
                        </ul>
                            ...
                            <div class="tab-content">
                                <div role="tabpanel" class="tab-pane active" id="amend_terms">
                                                            ...
                                                            <div class="input-group">
                                                                ...
                                                                <datepicker  date-format="yyyy-M-dd">
                                                                    <input 
                                                                        ...
                                                                        name = "opening_date"
                                                                        autocomplete="off"
                                                                        ng-change = "generate_expiryDate2('rent_period', data.opening_date)">
                                                                </datepicker>
                                                            </div>
                                                        </div>
                                                    </div>
                                    ...
                                    <div role="tabpanel" class="tab-pane" id="amend_attachments" >
                                        <div class="col-md-10 col-md-offset-1">
                                            ...
                                            <div class="row">
                                                <div class="panel panel-default">
                                                    <div class="panel-heading"><i class="fa fa-image"></i> Contract Documents (Required)</div>
                                                    <div class="panel-body">
                                                        <div class="col-md-12">
                                                            <input id="contract_docs" name = "contract_docs[]" type="file" multiple="multiple" ng-model="contract_docs">
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                ...
                                <div class="row">
                                    <div class="col-md-12 text-right">
                                        <button type = "button" onclick="amend_tenant('<?php echo base_url(); ?>index.php/leasing_transaction/amend_tenant');"  ng-disabled = "frm_amendment.$invalid" class="btn btn-medium btn-primary button-b"><i class = "fa fa-save"></i> Submit</button>
                                    </div>
                                </div>
                            </form>
                        </div>
        ...
        <div class="modal-dialog modal-sm">
            <div class="modal-content">
                ...
                <form action="#"  method="post" id="frm_managerKey" name = "frm_managerKey">
                    ...
                    <div class="modal-footer">
                        <button type="button"  onclick="amend_tenant('<?php echo base_url(); ?>index.php/leasing_transaction/amend_tenant/');" class="btn btn-primary button-b" data-dismiss="modal"> <i class="fa fa-key"></i> Submit</button>
