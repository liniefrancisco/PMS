                                        ...
                                        <form action="#"  method="post" id="frm_invoice" name = "frm_invoice">
                                            ...
                                            <div class="row"> <!-- ROW FOR BUTTONS -->
                                                <div class = "col-md-12 text-right">
                                                    <button type = "button" onclick="check_invoiceTag()" ng-disabled = "frm_invoice.$invalid" class = "btn btn-primary btn-medium button-b"><i class = "fa fa-save"></i> Save Invoice</button>
                                                </div>
                                            </div>
                                        </form>
                                    </div>
    ...
    <div class="modal-dialog modal-sm">
        <div class="modal-content">
            ...
            <form action="#"  method="post" id="frm_tag" name = "frm_tag">
                ...
                <div class="modal-footer">
                    <button type="button" onclick="save_draftInvoice('<?php echo base_url(); ?>index.php/leasing_transaction/save_draftInvoice/')" class="btn btn-primary button-b" data-dismiss="modal"> <i class="fa fa-save"></i> Proceed</button>
                </div>
            </form>
        </div><!-- /.modal-dialog -->
    </div><!-- /.modal -->
