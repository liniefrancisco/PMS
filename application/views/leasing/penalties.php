											...
											<div class="col-md-6">
															...
															<div class="input-group">
																...
																<span class="input-group-btn">
																	<button class="btn btn-info" type="button"
																		ng-click="tenant_penalties(dirty.value, tenancy_type)"><i
												...
												<div class="row">
													<div class="form-group">
														...
														<div class="col-md-7">
															<input type="text" readonly ng-model="corporate_name"
													...
													<div class="btn-group">
														...
														<ul class="dropdown-menu">
															<li><a href="#" data-backdrop="static" data-keyboard="false"
																	data-toggle="modal" data-target="#attachment_modal"
																	ng-click="pass_URLtoManagerModal('<?php echo base_url(); ?>index.php/leasing_transaction/waive_penalty/' + dt.id)">
																	<i class="fa fa-close"></i> Waive Penalty</a></li>
														</ul>
													</div>
												</td>
											</tr>
	...
	<div class="modal fade" id="attachment_modal">
		<div class="modal-dialog modal-medium">
			<div class="modal-content">
				...
				<form action="#" onsubmit="" method="post" id="frm_penalty" enctype="multipart/form-data"
					name="frm_penalty">
								...
								<div class="row">
									<div class="form-group">
										<label for="address" class="col-md-4 control-label text-right"><i
												class="fa fa-asterisk"></i>Waiver</label>
										<div class="col-md-6 text-right">
											<input type="file" class="form-control" id="waiver" required name="waiver"
												autocomplete="off">
										</div>
									</div>
								</div>
