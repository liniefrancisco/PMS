                ...
                <div class="row">
                    <div class="col-md-12">
                        <table class="table table-bordered" ng-table="tableParams" ng-controller="tableController"
                            ng-init="loadList('<?php echo base_url(); ?>index.php/leasing_mstrfile/get_charges_setup')">
                            <tbody>
                                <tr class="ng-cloak" ng-repeat="charges in data">
                                    ...
                                    <td title="'Unit Price'" sortable="'unit_price'" align="right">{{ charges.unit_price
                                        | currency : '&#8369;' }}</td>
                                    <td align="center">
                                        <span ng-if="charges.with_penalty == 'Yes'" class="green"><i
                                                class="fa fa-check"></i></span>
                                        <span ng-if="charges.with_penalty != 'Yes'" class="red"><i
                                            ...
                                            <div class="btn-group">
                                                ...
                                                <ul class="dropdown-menu">
                                                    <li><a href="#" data-backdrop="static" data-keyboard="false"
                                                            ...
                                                            ng-click="update('<?php echo base_url(); ?>index.php/leasing_mstrfile/get_chargesSetup_data/' + charges.id)">
                                                            <i class="fa fa-edit"></i> Update</a></li>
                                                    <li><a href="#" data-toggle="modal" data-target="#confirmation_modal"
                                                            ng-click="delete('<?php echo base_url(); ?>index.php/leasing_mstrfile/delete_charges/' + charges.id)">
                        ...
                        <div class="row">
                            <div class="col-md-11">
                                <div class="row">
                                    <div class="form-group">
                                        <label for="description" class="col-md-4 control-label text-right"><i
                                                class="fa fa-asterisk"></i>Charges Type</label>
                                        <div class="col-md-8">
                                            <select class="form-control" required name="charges_type"
                                                ng-model="data.charges_type">
                                ...
                                <div class="row">
                                    <div class="form-group">
                                        <label for="description" class="col-md-4 control-label text-right"><i
                                                class="fa fa-asterisk"></i>Charges Code</label>
                                        <div class="col-md-8">
                                            <input type="text" required readonly class="form-control"
                                                ng-model="data.charges_code" id="charges_code" name="charges_code">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-8" ng-show="data.charges_type != 'Pre Operation Charges'">
                                            <select class="form-control" name="uom" ng-model="data.uom" id="uom">
                                        ...
                                        <div class="row" ng-show="data.charges_type == 'Pre Operation Charges'">
                                            <div class="col-md-2 pull-left">
                                                <input type="number" ng-model="data.uom" name="numberOfmons"
                                                    id="numberOfmons" class="form-control" />
                                            </div>
                                ...
                                <div class="row">
                                    <div class="form-group">
                                        <label for="unit_price" class="col-md-4 control-label text-right"><i
                                                class="fa fa-asterisk"></i>Unit Price</label>
                                        <div class="col-md-8">
                                            <div class="input-group">
                                                <div class="input-group-addon"><strong>&#8369;</strong></div>
                                                <input type="text" required class="form-control currency"
                                                    ng-model="data.unit_price" format="number" id="unit_price"
                                                    name="unit_price" autocomplete="off">
                                                <!-- FOR ERRORS -->
                                                <div class="validation-Error">
                                                    <span
                                                        ng-show="frm_update.unit_price.$dirty && frm_update.unit_price.$error.required">
                                                        <p class="error-display">This field is required.</p>
                                                    </span>
                                                </div>
                                            </div>
                                ...
                                <div class="row">
                                    <label for="unit_price" class="col-md-4 control-label text-right"></i>With
                                        Penalty</label>
                                    <div class="col-md-8">
                                        <div class="btn-group" data-toggle="buttons">
                                            <label>
                                                <input type="checkbox" ng-checked="data.with_penalty == 'Yes'"
                                                    name="with_penalty" value="Yes" autocomplete="off" />
                                            </label>
                                        </div>
                                    </div>
                                </div>
    ...
    <div class="modal fade" id="add_data">
        <div class="modal-dialog modal-md">
            <div class="modal-content">
                ...
                <form action="<?php echo base_url(); ?>index.php/leasing_mstrfile/add_charges" name="add_form"
                    method="post">
                            ...
                            <div class="col-md-11">
                                <div class="row">
                                    <div class="form-group">
                                        <label for="description" class="col-md-4 control-label text-right"><i
                                                class="fa fa-asterisk"></i>Charges Type</label>
                                        <div class="col-md-8">
                                            <select class="form-control" required ng-model="charges_type"
                                                name="charges_type">
                                ...
                                <div class="row">
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-8">
                                            <input type="text" required readonly class="form-control"
                                                value="<?php echo $charge_code; ?>" id="charges_code"
                                                name="charges_code">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-8" ng-show="charges_type != 'Pre Operation Charges'">
                                            <select class="form-control" name="uom" ng-model="uom" id="uom">
                                                <option value="" disabled="" selected="" style="display:none">Please
                                                    Select One</option>
                                                <option>Per Kilowatt Hour</option>
                                                <option>Per Kilogram</option>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-8">
                                            <div class="input-group">
                                                <div class="input-group-addon"><strong>&#8369;</strong></div>
                                                <input type="text" required class="form-control currency"
                                                    ng-model="unit_price" format="number" id="unit_price"
                                                    name="unit_price" autocomplete="off">
                                                <!-- FOR ERRORS -->
                                                <div class="validation-Error">
                                                    <span
                                                        ng-show="add_form.unit_price.$dirty && add_form.unit_price.$error.required">
                                                        <p class="error-display">This field is required.</p>
                                                    </span>
                                                </div>
                                            </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-8">
                                        <div class="btn-group" data-toggle="buttons">
                                            <label>
                                                <input type="checkbox" name="with_penalty" value="Yes"
                                                    autocomplete="off" />
                                            </label>
                                        </div>
                                    </div>
