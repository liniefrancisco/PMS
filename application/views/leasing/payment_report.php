                        ...
                        <div class="tab-content ng-cloak">
                            <div role="tabpanel" class="tab-pane active" id="preop">
                                <div class="col-md-10 col-md-offset-3" style="padding-top: 4%;">
                                    <div class="row">
                                        <form action=""
                                            onSubmit="payment_report('<?php echo base_url() ?>index.php/Leasing_reports/generate_paymentReport'); return false"
                                            method="post" id="frm_paymentReport" name="frm_paymentReport">
                                            <div class="row">
                                                    ...
                                                    <div class="row">
                                                        <div class="form-group">
                                                            <div class="col-md-12 col-md-offset-4">
                                                                <input type="checkbox" name="description[]" value="Cash"
                                                                    id="cash" /> <label for="cash">Cash</label>
                                                                <input type="checkbox" name="description[]"
                                                                    value="Check" id="check" /> <label
                                                                    for="check">Check</label>
                                                                <input type="checkbox" name="description[]"
                                                                    value="Bank to Bank" id="otc" /> <label
                                                                    for="otc">OTC Payment</label>
                                                                <input type="checkbox" name="description[]" value="JV"
                                                                    id="jv" /> <label for="jv">Journal Voucher</label>
                                                            </div>
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="row pull-right" style="padding-right: 13%">
                                                    <div class="col-md-12">
                                                        <div class="text-center">
                                                            ...
                                                            <label><input type="radio" name="doc_type" value="pdf">
                                                                PDF</label>
                                                            <label><input type="radio" name="doc_type" value="excel">
                                                                Excel</label>
