                                    ...
                                    <table class="table table-bordered" id="creditmemo_table">
                                        ...
                                        <tbody id="creditmemo_tbody">
                                            <tr ng-repeat="data in basicData">
                                                ...
                                                <td>
                                                    <button type="button"
                                                        ng-click="apply_CreditMemo(data.id, data.description, data.balance)"
                                                        class="btn btn-xs btn-danger">Apply Credit</button>
                                                </td>
                                            </tr>
                                        </tbody>
    ...
    <div class="modal fade" id="modal_creditMemo" style="top: 70px">
        <div class="modal-dialog modal-sm">
            <div class="modal-content">
                ...
                <form action="<?php echo base_url(); ?>index.php/leasing_transaction/other_creditMemo/" method="post"
                    name="frm_creditMemo" id="frm_creditMemo">
                                        ...
                                        <div class="col-md-12">
                                            <div class="input-group">
                                                ...
                                                <input type="text" required class="form-control currency"
                                                    ng-model="credit_amount" id="credit_amount" max="max_credit"
                                                    ui-number-mask="2" name="credit_amount" autocomplete="off">
                                            </div>
                                            ...
                                            <div class="validation-Error">
                                                <span
                                                    ng-show="frm_creditMemo.credit_amount.$dirty && frm_creditMemo.credit_amount.$error.required">
                                                    <p class="error-display">This field is required.</p>
                                                </span>
                                                <span
                                                    ng-show="frm_creditMemo.credit_amount.$dirty && frm_creditMemo.credit_amount.$error.max">
    ...
    <div class="modal fade" id="basic_creditMemo_modal" style="top: 70px">
        <div class="modal-dialog modal-sm">
            <div class="modal-content">
                ...
                <form action="<?php echo base_url(); ?>index.php/leasing_transaction/basic_creditMemo/" method="post"
                    name="frm_creditMemo" id="frm_creditMemo">
                    <div class="modal-body">
                        <div class="row">
                            <div class="col-md-12">
