                                ...
                                <div class="row"> <!-- table wrapper  -->
                                    ...
                                    <table ng-table="tableParams" class="table table-bordered" show-filter="false"
                                        ...
                                        <tr ng-repeat="dt in data">
                                            ...
                                            <td title="'Running Balance'" sortable="'running_balance'">{{ dt.balance |
                                                currency : ''}}</td>
                                        </tr>
                                    ...
                                    <div class="col-md-12">
                                        <a style="margin-right: 10px"
                                            class="btn btn-default btn-medium pull-right button-w" href="#"
                                            data-backdrop="static" data-keyboard="false" data-toggle="modal"
                                            data-target="#export_CSV"><i class="fa fa-download"></i> Export CSV</a>
                                    </div>
                                </div>
                            </div>
    ...
    <div class="modal fade" id="export_CSV">
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                ...
                <form action="<?php echo base_url() ?>index.php/leasing_reports/generate_GLCSV" method="post"
                    onSubmit="closeModal('export_CSV')" id="frm_generatecsv" name="frm_generatecsv">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="col-md-6">
                                    <div class="row">
                                        <div class="form-group">
                                            <label for="beginning_date" class="col-md-4 control-label text-right"><i
                                            ...
                                            <div class="col-md-8">
                                                <div class="input-group">
                                                    ...
                                                    <datepicker date-min-limit="" date-format="yyyy-M-dd">
                                                        <input type="text" required readonly placeholder="Choose a date"
                                                            class="form-control" ng-model="beginning_date"
                                ...
                                <div class="col-md-6">
                                    <div class="row">
                                        <div class="form-group">
                                            <label for="end_date" class="col-md-4 control-label text-right"><i
                                            ...
                                            <div class="col-md-8">
                                                <div class="input-group">
                                                    ...
                                                    <datepicker date-min-limit="" date-format="yyyy-M-dd">
                                                        <input type="text" required readonly placeholder="Choose a date"
                                                            class="form-control" ng-model="end_date" id="end_date"
                            ...
                            <div class="row">
                                <div class="col-md-12 text-center" style="padding-top: 20px">
                                    <button type="submit" ng-disabled="frm_generatecsv.$invalid"
                                        class="btn btn-lg btn-primary button-vl"> <i class="fa fa-cog"></i>
                                        Generate</button>
                                </div>
                            </div>
                        </div>
