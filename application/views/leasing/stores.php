                    ...
                    <div class="col-md-12">
                        ...
                        <table ng-table="tableParams" ng-controller="tableController" class="table table-bordered" show-filter="false" ng-init="loadList('<?php echo base_url(); ?>index.php/leasing_mstrfile/get_stores')">
                            <tr ng-repeat="dt in data">
                                ...
                                <td title="'TIN'" sortable="'tin'">{{dt.tin}}</td>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="col-md-6">
                                    ...
                                    <div class="row">
                                        <div class="form-group">
                                            <label for="managed_by" class="col-md-4 control-label text-right"><i class = "fa fa-asterisk"></i>Managed By</label>
                                            <div class="col-md-8">
                                                <input
                                                    type="text"
                                                    ng-model="data.managed_by"
                                                    required
                                                    autocomplete = "off"
                                                    class="form-control"
                                                    name = "managed_by"
                                                ...
                                                <!-- FOR ERRORS -->
                                                <div class="validation-Error">
                                                    <span ng-show="frm_update.managed_by.$dirty && frm_update.managed_by.$error.required">
                                                        <p class="error-display">This field is required.</p>
                                                    </span>
                                                </div>
                                            </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-8">
                                                <input
                                                    ...
                                                    <!-- Error -->
                                                    <div class="validation-Error">
                                                        <span ng-show="frm_update.tin.$dirty && frm_update.tin.$error.required">
                                                            <p class="error-display">This field is required.</p>
                                                        </span>
                                                    </div>
                                            </div>
                                    ...
                                    <div class="row">
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-8">
                                                ...
                                                <!-- FOR ERRORS -->
                                                <div class="validation-Error">
                                                    <span ng-show="add_form.managed_by.$dirty && add_form.managed_by.$error.required">
                                                        <p class="error-display">This field is required.</p>
                                                    </span>
                                                </div>
                                            </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-8">
                                                <input
                                                    ...
                                                    <!-- Error -->
                                                    <div class="validation-Error">
                                                        <span ng-show="add_form.tin.$dirty && add_form.tin.$error.required">
                                                            <p class="error-display">This field is required.</p>
                                                        </span>
                                                    </div>
                                            </div>
        ...
        <div class="modal-dialog modal-md">
            <div class="modal-content">
                ...
                <form action="#" id="frm_addfloor" name="add_floor" method="post">
                    ...
                    <div class="modal-footer">
                        <button type="submit" ng-disabled = "add_floor.$invalid" class="btn btn-primary button-b"> <i class="fa fa-save"></i> Submit</button>
                        <button type="button" class="btn btn-danger button-r" data-dismiss="modal"> <i class="fa fa-close"></i> Close</button>
                    </div>
                </form>
            </div><!-- /.modal-content -->
        ...
        <div class="modal-dialog modal-md">
            <div class="modal-content">
                ...
                <form action="#" id="frm_addselectedBank" name="frm_addselectedBank" method="post">
                    <div class="modal-body">
                        <div class="row">
                            <div class="col-md-10 col-md-offset-1">
                                <div class="row">
                                    <div class="form-group">
                                        <label for="store_name" class="col-md-3 control-label text-right"><i class = "fa fa-asterisk"></i>Bank Name</label>
                                        <div class="col-md-9">
                    ...
                    <div class="modal-footer">
                        <button type="submit" ng-disabled = "frm_addselectedBank.$invalid" class="btn btn-primary button-b"> <i class="fa fa-save"></i> Submit</button>
                        <button type="button" class="btn btn-danger button-r" data-dismiss="modal"> <i class="fa fa-close"></i> Close</button>
                    </div>
                </form>
            </div><!-- /.modal-content -->
