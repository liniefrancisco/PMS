                        ...
                        <div class="tab-content ng-cloak">
                            <div role="tabpanel" class="tab-pane active" id="general_ledger">
                                <div class="row"> <!-- table wrapper  -->
                                    ...
                                    <table class="table table-bordered" id="generalLedger_table" ng-table="tableParams"
                                        ng-init="loadList('<?php echo base_url(); ?>index.php/leasing_reports/get_waivedPenalties')">
                                        ...
                                        <tbody id="subsidiaryLedger_tbody">
                                            <tr class="ng-cloak" ng-repeat="dt in data">
                                                ...
                                                <td title="'Prepared By'" sortable="'prepared_by'">{{ dt.prepared_by }}
                                                </td>
                                                <td align="center">
                                                    <!-- Split button -->
                                                    <div class="btn-group">
                                                        ...
                                                        <ul class="dropdown-menu">
                                                            <li><a href="#" data-backdrop="static" data-keyboard="false"
                                                                    data-toggle="modal"
                                                                    ng-click="previewImg('<?php echo base_url(); ?>assets/other_img/' + dt.attachment)"
                                                                    data-target="#preview_img" ng-click=""> <i
                                                                        class="fa fa-eye"></i> View Attachment</a></li>
                                                        </ul>
                                                    </div>
                                                </td>
                                            </tr>
