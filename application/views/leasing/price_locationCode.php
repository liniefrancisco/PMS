                ...
                <div class="row">
                    <div class="col-md-12">
                        <table class="table table-bordered" ng-controller="tableController"
                            ng-init="loadList('<?php echo base_url(); ?>index.php/leasing_mstrfile/get_price_locationCode')">
                            <thead>
                                <tr>
                                    <th width="15%"><a href="#"
                                    ...
                                    <th width="15%"><a href="#"
                                            data-ng-click="sortField = 'floor_name'; reverse = !reverse">Floor
                                            Location</a></th>
                                    <th width="10%"><a href="#"
                                            data-ng-click="sortField = 'floor_area'; reverse = !reverse">Floor Area
                                            m<sup>2</sup></a></th>
                                    <th width="10%"><a href="#"
                                            data-ng-click="sortField = 'price'; reverse = !reverse">Price Per
                                            m<sup>2</sup></a></th>
                                    <th width="15%"><a href="#"
                                            data-ng-click="sortField = 'basic_rental'; reverse = !reverse">Basic
                                            Rental/Month</a></th>
                                    <th width="10%"><a href="#"
                                            data-ng-click="sortField = 'status'; reverse = !reverse">Status</a></th>
                                    <?php if ($this->session->userdata('user_type') == 'Administrator'): ?>
                            ...
                            <tbody>
                                <tr class="ng-cloak" ng-show="dataList.length!=0"
                                    ng-repeat="price in dataList | filter:query | orderBy:sortField:reverse | offset: currentPage*itemsPerPage | limitTo: itemsPerPage">
                                    ...
                                    <td>
                                        <div ng-if="price.status == 'Occupied'"><span class="red">{{ price.status
                                                }}</span></div>
                                        <div ng-if="price.status != 'Occupied'"> <span class="green">Vacant</span>
                                        </div>
                                    </td>
                                    <?php if ($this->session->userdata('user_type') == 'Administrator'): ?>
                                        <td align="center">
                                            ...
                                            <div class="btn-group">
                                                ...
                                                <ul class="dropdown-menu">
                                                    <li><a href="#" data-backdrop="static" data-keyboard="false"
                                                            ...
                                                            ng-click="update('<?php echo base_url(); ?>index.php/leasing_mstrfile/get_locationCode_data/' + price.id)">
                                                            <i class="fa fa-edit"></i> Update</a></li>
                                                    <li><a href="#" data-toggle="modal" data-target="#confirmation_modal"
                                                            ng-click="delete('<?php echo base_url(); ?>index.php/leasing_mstrfile/delete_price_locationCode/' + price.id)">
        ...
        <div class="modal-dialog modal-md">
            <div class="modal-content">
                ...
                <div class="modal-body" ng-repeat="data in updateData">
                    <form action="{{ 'update_locationCode/' + data.id }}" method="post" name="frm_update"
                        id="frm_update">
                        <div class="row">
                            <div class="col-md-11">
                                <div class="row">
                                    <div class="form-group">
                                        <label for="store_name" class="col-md-4 control-label text-right"><i
                                                class="fa fa-asterisk"></i>Store/Property</label>
                                        <div class="col-md-8">
                                            <?php if ($this->session->userdata('user_type') == 'Administrator'): ?>
                                                <select name="store_name" required class="form-control"
                                                    ng-model="data.store_name" id="store_name"
                                            ...
                                            <?php else: ?>
                                                <input type="text" name="store_name" class="form-control" readonly
                                                    value="<?php echo $user_group; ?>">
                                            <?php endif ?>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    <div class="form-group">
                                        <label for="floor_name" class="col-md-4 control-label text-right"><i
                                                class="fa fa-asterisk"></i>Floor Location</label>
                                        <div class="col-md-8">
                                            <?php if ($this->session->userdata('user_type') == 'Administrator'): ?>
                                                <select class="form-control" name="floor_name" required
                                                    ng-model="data.floor_name" id="update_floor_name"
                                ...
                                <div class="row">
                                    <div class="form-group">
                                        <label for="floor_price" class="col-md-4 control-label text-right"><i
                                                class="fa fa-asterisk"></i>Floor Price</label>
                                        <div class="col-md-8">
                                            <div class="input-group">
                                                <div class="input-group-addon"><strong>&#8369;</strong></div>
                                                <input type="text" required readonly class="form-control currency"
                                                    ng-model="data.price" format="number" id="update_floorPriceId"
                                                    name="floor_price" autocomplete="off">
                                                <!-- FOR ERRORS -->
                                                <div class="validation-Error">
                                                    <span
                                                        ng-show="add_form.floor_price.$dirty && add_form.floor_price.$error.required">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-8">
                                            <input type="text" required class="form-control currency"
                                                ng-model="data.location_code" id="location_code" name="location_code"
                                                autocomplete="off" is-unique-update is-unique-id="{{data.id}}"
                                                is-unique-api="../ctrl_validation/verify_locationCode_update/">
                                            <!-- FOR ERRORS -->
                                            <div class="validation-Error">
                                                <span
                                                    ng-show="frm_update.location_code.$dirty && frm_update.location_code.$error.required">
                                                    <p class="error-display">This field is required.</p>
                                                </span>
                                                <span
                                                    ng-show="frm_update.location_code.$dirty && frm_update.location_code.$error.unique">
                                ...
                                <div class="row">
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-8">
                                            <div class="input-group">
                                                <div class="input-group-addon squared"><strong>m<sup>2</sup></strong>
                                                </div>
                                                <input type="text" required class="form-control currency"
                                                    format="number" ng-model="data.floor_area" id="floor_areaID"
                                                    name="floor_area" autocomplete="off"
                                                    ng-keyup="compute_basicRental_update(data.floor_area, 'update_floorPriceId', 'basic_rentalID')">
                                                {{ user.username }}
                                                <!-- FOR ERRORS -->
                                                <div class="validation-Error">
                                                    <span
                                                        ng-show="add_form.floor_area.$dirty && add_form.floor_area.$error.required">
                                                        <p class="error-display">This field is required.</p>
                                                    </span>
                                                </div>
                                            </div>
                                ...
                                <div class="row">
                                    <div class="form-group">
                                        <label for="basic_rental" class="col-md-4 control-label text-right"><i
                                                class="fa fa-asterisk"></i>Basic Rental/Month</label>
                                        <div class="col-md-8">

                                            <div class="input-group">
                                                <div class="input-group-addon"><strong>&#8369;</strong></div>
                                                <input type="text" required readonly class="form-control currency"
                                                    ng-model="data.basic_rental" format="number" id="basic_rentalID"
                                                    name="basic_rental" autocomplete="off">
                                                <!-- FOR ERRORS -->
                                                <div class="validation-Error">
                                                    <span
                                                        ng-show="add_form.basic_rental.$dirty && add_form.basic_rental.$error.required">
                                                        <p class="error-display">This field is required.</p>
                                                    </span>
                                                </div>
                                            </div>
    ...
    <div class="modal fade" id="add_data">
        <div class="modal-dialog modal-md">
            <div class="modal-content">
                ...
                <form action="<?php echo base_url(); ?>index.php/leasing_mstrfile/add_locationCode" name="add_form"
                    method="post">
                            ...
                            <div class="col-md-11">
                                <div class="row">
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-8">
                                            <?php if ($this->session->userdata('user_type') == 'Administrator'): ?>
                                                <select name="store_name" required class="form-control"
                                                    ng-model="store_name" id="store_name"
                                            ...
                                            <?php else: ?>
                                                <input type="text" class="form-control" name="store_name" readonly
                                                    value="<?php echo $user_group; ?>">
                                            <?php endif ?>
                                        </div>
                                    </div>
                                ...
                                <div class="row">
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-8">
                                            <?php if ($this->session->userdata('user_type') == 'Administrator'): ?>
                                                <select class="form-control" name="floor_name" required
                                                    ng-model="floor_name" id="floor_name"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-8">
                                            <div class="input-group">
                                                <div class="input-group-addon"><strong>&#8369;</strong></div>
                                                <input type="text" required readonly class="form-control currency"
                                                    ng-model="floorPrice" format="number" id="floor_price"
                                                    name="floor_price" autocomplete="off">
                                                <!-- FOR ERRORS -->
                                                <div class="validation-Error">
                                                    <span
                                ...
                                <div class="row">
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-8">
                                            <input type="text" required class="form-control currency"
                                                ng-model="location_code" id="location_code" name="location_code"
                                                autocomplete="off" is-unique
                                                is-unique-api="../ctrl_validation/verify_locationCode/">
                                            <!-- FOR ERRORS -->
                                            <div class="validation-Error">
                                                <span
                                                    ng-show="add_form.location_code.$dirty && add_form.location_code.$error.required">
                                                    <p class="error-display">This field is required.</p>
                                                </span>
                                                <span
                                                    ng-show="add_form.location_code.$dirty && add_form.location_code.$error.unique">
                                                    <p class="error-display">Data already exist.</p>
                                                </span>
                                            </div>
                                        </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-8">
                                            <div class="input-group">
                                                ...
                                                <input type="text" required class="form-control currency"
                                                    format="number" ng-model="floor_area" id="floor_area"
                                                    name="floor_area" autocomplete="off"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-8">
                                            ...
                                            <div class="input-group">
                                                <div class="input-group-addon"><strong>&#8369;</strong></div>
                                                <input type="text" required readonly class="form-control currency"
                                                    ng-model="basic_rental" format="number" id="basic_rental"
                                                    name="basic_rental" autocomplete="off">
                                                <!-- FOR ERRORS -->
                                                <div class="validation-Error">
                                                    <span
