                                            ...
                                            <div class="panel panel-default">
                                                ...
                                                <div class="panel-body">
                                                    <div class="col-md-12">
                                                        ...
                                                        <input id="contract_docs" name = "contract_docs[]]" type="file" multiple="multiple">
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                        ...
                        <div class="row">
                            <div class="col-md-12 text-right">
                                <!-- <?php if ($this->session->userdata('user_group') == '0' && $this->session->userdata('user_group') == null): ?>
                                    <button type = "button" onclick="add_tenant('<?php echo base_url(); ?>index.php/leasing_transaction/renew/');" ng-disabled = "frm_contract.$invalid" class="btn btn-medium btn-primary button-b"><i class = "fa fa-save"></i> Submit</button>
                                <?php else: ?>
                                    <button type = "button" data-toggle="modal" data-target="#managerkey_modal" ng-disabled = "frm_contract.$invalid" class="btn btn-medium btn-primary button-b"><i class = "fa fa-save"></i> Submit</button>
                                <?php endif ?>
...
<!--------------------------------------------------------------------------------------- gwapss ------------------------------------------------------------------------------>
                                ...
                                if ($previous_page == 'sterminated_contract') {
                                    $back_url = base_url('index.php/leasing_transaction/sterminated_contract');
                                } elseif ($previous_page == 'lterminated_contract') {
                                    $back_url = base_url('index.php/leasing_transaction/lterminated_contract');
                                } else {
                                    $back_url = base_url('index.php/leasing_transaction/lst_Lforcontract');
                                }
                                if ( $this->session->userdata('user_type') == 'Admin' || $this->session->userdata('user_type') == 'Supervisor' || $this->session->userdata('user_type') == 'Corporate Leasing Supervisor'): ?>
                                ...
                                <?php endif ?>
                                <a href="<?php echo $back_url; ?>" class="btn btn-medium btn-default"><i class="fa fa-arrow-circle-left"></i> Back</a>
<!--------------------------------------------------------------------------------------- gwapss end ------------------------------------------------------------------------------>
                            </div>
                        </div>
                    </form>
            ...
            <div class="modal-content">
                ...
                <form action="#"  method="post" id="frm_managerKey" name = "frm_managerKey">
                    ...
                    <div class="modal-footer">
                        <button type="button" onclick="add_tenant('<?php echo base_url(); ?>index.php/leasing_transaction/renew/');" class="btn btn-primary button-b" data-dismiss="modal"> <i class="fa fa-key"></i> Submit</button>
