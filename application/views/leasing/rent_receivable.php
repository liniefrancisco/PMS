<div class="container" ng-controller="transactionController">
	<div class="well">
		<div class="panel panel-default">
			<div class="panel-heading panel-leasing"><i class="fa fa-edit"></i> Rent Receivable</div>
						...
						<div class="tab-content ng-cloak">
							<div role="tabpanel" class="tab-pane active" id="payment">
								<div class="row"> <!-- table wrapper  -->
									<table class="table table-bordered" id="subsidiaryLedger_table"
												...
												<div class="row">
													<div class="col-md-3 pull-right">
														<input type="text" class="form-control search-query"
															placeholder="Search Here..." ng-model="query" />
													</div>
												</div>
											</div>
											<tr>
												<th><a href="#"
														data-ng-click="sortField = 'trade_name'; reverse = !reverse">Trade
														Name</a></th>
												<th><a href="#"
														data-ng-click="sortField = 'doc_no'; reverse = !reverse">Document
														No.</a></th>
												<th><a href="#"
														data-ng-click="sortField = 'ref_no'; reverse = !reverse">Ref.
														No.</a></th>
												<th><a href="#"
												...
												<th><a href="#"
														...
														Date</a></th>
												<th><a href="#"
														data-ng-click="sortField = 'amount'; reverse = !reverse">Amount</a>
												</th>
											</tr>
										</thead>
										<tbody id="subsidiaryLedger_tbody"
											ng-init="get_rentReceivable(date_from, date_to)">
									...
									<div class="col-md-12">
										<a class="btn btn-default btn-medium pull-right button-w"
											href="<?php echo base_url(); ?>index.php/leasing_reports/export_rentReceivable/{{date_from}}/{{date_to}}"><i
