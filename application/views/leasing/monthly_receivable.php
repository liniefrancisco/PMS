                        ...
                        <div class="tab-content ng-cloak">
                            <div role="tabpanel" class="tab-pane active" id="preop">
                                <div class="col-md-10 col-md-offset-3" style="padding-top: 4%;">
                                    <div class="row">
                                        <form action=""
                                            onSubmit="generate_monthly_receivable('<?php echo base_url() ?>index.php/leasing_reports/generate_monthly_receivable'); return false"
                                            method="post" id="frm_monthlyReceivable" name="frm_monthlyReceivable">
                                            <div class="row">
                                                <div class="col-md-6"> <!-- SECOND COL-MD-6 WRAPPER -->
                                                    <div class="row">
                                                        <div class="form-group">
                                                            ...
                                                            <div class="col-md-8 text-left">
                                                                <select name="tenancy_type" class="form-control"
                                                                    required ng-model="tenancy_type">
                                                            ...
                                                            <div class="col-md-8 text-left">
                                                                <div class="input-group">
                                                                    ...
                                                                    <div class="validation-Error">
                                                                        <span
                                                                            ng-show="frm_monthlyReceivable.beginning_date.$dirty && frm_monthlyReceivable.beginning_date.$error.required">
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <div class="col-md-8 text-left">
                                                                <div class="input-group">
                                                                    ...
                                                                    <div class="validation-Error">
                                                                        <span
                                                                            ng-show="frm_monthlyReceivable.end_date.$dirty && frm_monthlyReceivable.end_date.$error.required">
                                                                            <p class="error-display">This field is
                                                                                required.</p>
                                                                        </span>
                                                                    </div>
                                                    ...
                                                    <div class="row">
                                                        <div class="form-group">
                                                            <label for="beginning_date"
                                                                class="col-md-4 control-label text-right"><i
                                                                    class="fa fa-asterisk"></i>Document Type</label>
                                                            <div class="col-md-8 text-left">
                                                                <div class="input-group">
                                                                    <div class="input-group-addon input-date">
                                                                        <input type="radio" name="doc_type" value="pdf"
                                                                            checked="" id="radio-pdf">
                                                                    </div>
                                                                    <div class="input-group-addon input-date">
                                                                        <span>PDF</span>
                                                                    </div>
                                                                    ...
                                                                    <div class="input-group-addon input-date">
                                                                        <input type="radio" name="doc_type"
                                                                            value="excel">
                                                                    </div>
                                                                    <div class="input-group-addon input-date">
                                                                        <span>EXCEL</span>
                                            ...
                                            <div class="col-md-6">
                                                <div class="row pull-right" style="padding-right: 13%">
                                                    <div class="col-md-12">
                                                        <button type="submit"
                                                            ng-disabled="frm_monthlyReceivable.$invalid"
