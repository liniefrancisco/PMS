                ...
                <div class="row">
                    <div class="col-md-12">
                        <table class="table table-bordered" ng-table="tableParams" ng-controller="tableController"
                            ng-init="loadList('<?php echo base_url(); ?>index.php/leasing_reports/get_availableArea')">
                            <tbody>
                                <tr class="ng-cloak" ng-repeat="dt in data">
                                    ...
                                    <td title="'Floor Area'" sortable="'floor_area'">{{ dt.floor_area | currency : '' }}
                                    </td>
                                    <td title="'Rental Rate'" sortable="'rental_rate'">{{ dt.rental_rate | currency :
                                        '&#8369;' }}</td>
                                    <td title="'Status'" sortable="'status'" align="center"><span
                                            class="green"><b>Vacant</b></span></td>
                                </tr>
