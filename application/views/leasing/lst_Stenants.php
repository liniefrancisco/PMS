    ...
    <div class="well">
        <div class="panel panel-default">
          ...
          <div class="panel-heading panel-leasing">
                <i class="fa fa-list"></i> Short Term Tenants
                                    ...
                                    <td title = "'Action'" align="center" width="100px;">
                                        <div class="btn-group">
                                            ...
                                            <ul class="dropdown-menu">
                                                ...
                                                <?php if (!in_array($this->session->userdata('user_type'), ['Legal', 'IAD'])): ?> <!-- added by gwaps -->
                                                <li>
                                                    <a
                                                        href="#"
                                                        data-backdrop = "static" data-keyboard = "false"
                                        ...
                                        <div class="container-fluid">
                                            <table class="table table-bordered">
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        <td><img src="<?php echo base_url(); ?>img/Folder-icon.png" alt="Letter of Intent" style = "height:20px;"> Company Profile</td>
                                                    ...
                                                    <tr>
                                                        <td><img src="<?php echo base_url(); ?>img/Folder-icon.png" alt="Letter of Intent" style = "height:20px;"> DTI Business Registration</td>
                                                       <td><button class="btn btn-sm primary button-w" data-toggle="modal" data-target="#carousel_modal" ng-click="get_img('<?php echo base_url(); ?>index.php/leasing_transaction/get_dtibusireg/' + data.prospect_id, '<?php echo base_url(); ?>assets/other_img/')">View Document</button></td>
                                                    </tr>
                                                    <tr>
                                                        <td><img src="<?php echo base_url(); ?>img/Folder-icon.png" alt="Letter of Intent" style = "height:20px;"> Picture/Brochures of Products</td>
                                                    ...
                                                    <tr>
                                                        <td><img src="<?php echo base_url(); ?>img/Folder-icon.png" alt="Letter of Intent" style = "height:20px;"> Gross Sales(Percentage rent.)</td>
                                                    ...
                                                    <tr>
                                                        <td><img src="<?php echo base_url(); ?>img/Folder-icon.png" alt="Letter of Intent" style = "height:20px;"> Price/Menu List(for food tenants)</td>
                                                    ...
                                                    <tr>
                                                        <td><img src="<?php echo base_url(); ?>img/Folder-icon.png" alt="Letter of Intent" style = "height:20px;"> Contract Documents</td>
                                                        <td><button class="btn btn-sm primary button-w" data-target="#image_viewer" data-toggle="modal" ng-click="getContractDoc2(detail.tenant_id)">View Document</button></td>
                                                    </tr>
                                                    <tr>
                                                        <td><img src="<?php echo base_url(); ?>img/Folder-icon.png" alt="Letter of Intent" style = "height:20px;"> Supporting Documents</td>
...
<?php if ($this->session->userdata('user_type') != 'Accounting Staff' && $this->session->userdata('user_type') != 'Legal' && $this->session->userdata('user_type') != 'IAD'): ?> <!-- added by gwaps -->
                            <button 
                                    type="button" 
...
<?php endif; ?>
    ...
    <div class="modal fade" id = "image_viewer" style="overflow-y: scroll;">
        <div class="modal-dialog modal-md">
            <div class="modal-content">
                <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                        ...
                        <div id="myCarousel" class="carousel slide" data-interval="false">
                            ...
                            <div class="carousel-inner" role="listbox" style="min-height: 400px;">
                                ...
                                <div ng-repeat = "i in image" ng-class = "{item: true, active: ($index === 0)}">
                                    ...
                                    <!-- <img src = "<?= base_url('assets/contract_docs') ?>/{{ i.file_name }}" alt = "{{ i.file_name }}" style = "width:100%;"> -->
