<div class="container" id="transactionController" ng-controller="transactionController">
    <div class="well">
        <div class="panel panel-default">
            <div class="panel-heading panel-leasing"><i class="fa fa-pencil-square"></i> Monthly Payable & Amount Paid
            </div>
                                ...
                                <div class="col-md-10 col-md-offset-3" style="padding-top: 4%;">
                                    <div class="row">
                                        <form
                                            ...
                                            method="post" id="frm_monthlyPayable" name="frm_monthlyPayable">
                                            <div class="row">
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <div class="col-md-8 text-left">
                                                                ...
                                                                <div class="validation-Error">
                                                                    <span
                                                                        ng-show="frm_monthlyPayable.month.$dirty && frm_monthlyPayable.month.$error.required">
                                            ...
                                            <div class="col-md-6">
                                                <div class="row pull-right" style="padding-right: 13%">
                                                    <div class="col-md-12">
                                                        <button type="submit" ng-disabled="frm_monthlyPayable.$invalid"
