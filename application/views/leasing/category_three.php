                    ...
                    <?php if ($this->session->userdata('user_type') == 'Administrator'): ?>
                        <div class="col-md-3 pull-left">
                            <a href="#" data-backdrop="static" data-keyboard="false"
                                ng-click="populate_categoryOne('<?php echo base_url(); ?>index.php/leasing_mstrfile/get_category_one')"
                                data-toggle="modal" data-target="#add_data" class="btn btn-success btn-medium button-g"><i
                ...
                <div class="row">
                    <div class="col-md-12">
                        <table class="table table-bordered" ng-table="tableParams" ng-controller="tableController"
                            ng-init="loadList('<?php echo base_url(); ?>index.php/leasing_mstrfile/get_category_three/')">

                            <tbody>
                                <tr class="ng-cloak" ng-repeat="category in data">
                                    <td title="'First Level Category'" sortable="'first_level'">{{ category.first_level
                                        }}</td>
                                    <td title="'Second Level Category'" sortable="'second_level'">{{
                                        category.second_level }}</td>
                                    <td title="'Third Level Category'" sortable="'third_level'">{{ category.third_level
                                        }}</td>
                                            ...
                                            <div class="btn-group">
                                                ...
                                                <ul class="dropdown-menu">
                                                    <li><a href="#" data-backdrop="static" data-keyboard="false"
                                                            ...
                                                            ng-click="update('<?php echo base_url(); ?>index.php/leasing_mstrfile/get_categoryThree_data/' + category.id); populate_categoryOne('<?php echo base_url(); ?>index.php/leasing_mstrfile/get_category_one')">
                                                            <i class="fa fa-edit"></i> Update</a></li>
                                                    <li><a href="#" data-toggle="modal" data-target="#confirmation_modal"
                                                            ng-click="delete('<?php echo base_url(); ?>index.php/leasing_mstrfile/delete_categoryThree/' + category.id)">
        ...
        <div class="modal-dialog modal-md">
            <div class="modal-content">
                ...
                <div class="modal-body" ng-repeat="data in updateData">
                    <form action="{{ 'update_categoryThree/' + data.id }}" method="post" name="frm_update"
                        id="frm_update">
                        <div class="row">
                            <div class="col-md-8 col-md-offset-2">
                                <div class="form-group">
                                    <label for="first_level"><i class="fa fa-asterisk"></i>First Level Category</label>
                                    <select class="form-control" required ng-model="data.first_level" name="first_level"
                                        id="first_level"
                                ...
                                <div class="form-group">
                                    <label for="second_level"><i class="fa fa-asterisk"></i>Second Level
                                        Category</label>
                                    <select class="form-control" required ng-model="data.second_level"
                                        name="second_level" id="update_second_level">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" required ng-minlength="3" class="form-control"
                                        ng-model="data.third_level" id="third_level" name="third_level" is-unique-update
                                    ...
                                    <div class="validation-Error">
                                        <span
                                            ng-show="frm_update.third_level.$dirty && frm_update.third_level.$error.required">
                                            <p class="error-display">This field is required.</p>
                                        </span>
                                        <span
                                            ng-show="frm_update.third_level.$dirty && frm_update.third_level.$error.minlength">
                                            <p class="error-display">Minimum of 3 characters</p>
                                        </span>
                                        <span
                                            ng-show="frm_update.third_level.$dirty && frm_update.third_level.$error.unique">
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea required rows="3" class="form-control" ng-model="data.description"
                                        ng-minlength="3" name="description">
                                    </textarea>
                                    <!-- FOR ERRORS -->
                                    <div class="validation-Error">
                                        <span
    ...
    <div class="modal fade" id="add_data">
        <div class="modal-dialog modal-md">
            <div class="modal-content">
                ...
                <form action="<?php echo base_url(); ?>index.php/leasing_mstrfile/add_category_three" name="add_form"
                    method="post">
                    <div class="modal-body">
                        <div class="row">
                            <div class="col-md-8 col-md-offset-2">
                                <div class="form-group">
                                    <label for="first_level"><i class="fa fa-asterisk"></i>First Level Category</label>
                                    <select class="form-control" required ng-model="first_level" name="first_level"
                                        id="first_level"
                                        ng-change="populate_categoryTwo('<?php echo base_url(); ?>index.php/leasing_mstrfile/populate_categoryTwo/' + first_level)">
                                        <option value="" disabled="" selected="" style="display:none">Please Select One
                                        </option>
                                        <option ng-repeat="one in categoryOne">{{one.category_name}}</option>
                                    </select>
                                </div>
                                <div class="form-group">
                                    ...
                                    <select class="form-control" required ng-model="second_level" name="second_level"
                                        id="second_level">
                                        <option value="" disabled="" selected="" style="display:none">Please Select One
                                        </option>
                                        <option ng-repeat="two in categoryTwo">{{two.second_level}}</option>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" required ng-minlength="5" class="form-control"
                                        ng-model="third_level" id="third_level" name="third_level" is-unique
                                        is-unique-api="../ctrl_validation/verify_category_three/" autocomplete="off">
                                    <!-- FOR ERRORS -->
                                    <div class="validation-Error">
                                        <span
                                            ng-show="add_form.third_level.$dirty && add_form.third_level.$error.required">
                                            <p class="error-display">This field is required.</p>
                                        </span>
                                        <span
                                            ng-show="add_form.third_level.$dirty && add_form.third_level.$error.minlength">
                                            <p class="error-display">Minimum of 5 characters</p>
                                        </span>
                                        <span
                                            ng-show="add_form.third_level.$dirty && add_form.third_level.$error.unique">
                                            <p class="error-display">Data already exist.</p>
                                        </span>
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea required rows="3" class="form-control" ng-model="description"
                                        ng-minlength="3" name="description">
                                    </textarea>
                                    <!-- FOR ERRORS -->
                                    <div class="validation-Error">
