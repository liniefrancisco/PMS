                ...
                <div class="row">
                    <div class="col-md-12">
                        <table class="table table-bordered" ng-table="tableParams" ng-controller="tableController"
                            ng-init="loadList('<?php echo base_url(); ?>index.php/leasing_mstrfile/get_GLaccounts')">
                                            ...
                                            <div class="btn-group">
                                                ...
                                                <ul class="dropdown-menu">
                                                    <li><a href="#" data-backdrop="static" data-keyboard="false"
                                                            ...
                                                            ng-click="update('<?php echo base_url(); ?>index.php/leasing_mstrfile/get_glAccount_data/' + dt.id)">
                                                            <i class="fa fa-edit"></i> Update</a></li>
                                                    <li><a href="#" data-toggle="modal" data-target="#confirmation_modal"
                                                            ng-click="delete('<?php echo base_url(); ?>index.php/leasing_mstrfile/delete_GLaccount/' + dt.id)">
    ...
    <div class="modal fade" id="add_data">
        <div class="modal-dialog modal-md">
            <div class="modal-content">
                ...
                <form action="<?php echo base_url(); ?>index.php/leasing_mstrfile/add_GLaccount" name="add_form"
                    method="post">
                            ...
                            <div class="col-md-10 ">
                                <div class="row">
                                    <div class="form-group">
                                        <label for="gl_code" class="col-md-4 control-label text-right"><i
                                                class="fa fa-asterisk"></i>G/L Code</label>
                                        <div class="col-md-8">
                                            <input type="text" required class="form-control" ng-model="gl_code"
                                                id="gl_code" name="gl_code" is-unique
                                                is-unique-api="../ctrl_validation/verify_glCode/" autocomplete="off">
                                            <!-- FOR ERRORS -->
                                            <div class="validation-Error">
                                                <span
                                                    ng-show="add_form.gl_code.$dirty && add_form.gl_code.$error.required">
                                                    <p class="error-display">This field is required.</p>
                                                </span>
                                                <span
                                                    ng-show="add_form.gl_code.$dirty && add_form.gl_code.$error.unique">
                                ...
                                <div class="row">
                                    <div class="form-group">
                                        <label for="gl_account" class="col-md-4 control-label text-right"><i
                                                class="fa fa-asterisk"></i>G/L Account</label>
                                        <div class="col-md-8">
                                            <textarea ng-model="gl_account" required class="form-control"
                                                name="gl_account" id="gl_account" is-unique
                                            ...
                                            <div class="validation-Error">
                                                <span
                                                    ng-show="add_form.gl_account.$dirty && add_form.gl_account.$error.required">
                                                    <p class="error-display">This field is required.</p>
                                                </span>
                                                <span
                                                    ng-show="add_form.gl_account.$dirty && add_form.gl_account.$error.unique">
                                                    <p class="error-display">Data already exist.</p>
                                                </span>
                                            </div>
                                        </div>
                                ...
                                <div class="row">
                                    <div class="form-group">
                                        <label for="gl_code" class="col-md-4 control-label text-right"><i
                                                class="fa fa-asterisk"></i>G/L Code</label>
                                        <div class="col-md-8">
                                            <input type="text" required class="form-control" ng-model="data.gl_code"
                                                id="gl_code" name="gl_code" is-unique-update is-unique-id="{{data.id}}"
                                                is-unique-api="../ctrl_validation/verify_glCode_update/">
                                            <!-- FOR ERRORS -->
                                            <div class="validation-Error">
                                                <span
                                                    ng-show="frm_update.gl_code.$dirty && frm_update.gl_code.$error.required">
                                                    <p class="error-display">This field is required.</p>
                                                </span>
                                                <span
                                                    ng-show="frm_update.gl_code.$dirty && frm_update.gl_code.$error.unique">
                                                    <p class="error-display">Data already exist.</p>
                                                </span>
                                            </div>
                                        </div>
                                ...
                                <div class="row">
                                    <div class="form-group">
                                        <label for="gl_account" class="col-md-4 control-label text-right"><i
                                                class="fa fa-asterisk"></i>G/L Account</label>
                                        <div class="col-md-8">
                                            <textarea ng-model="data.gl_account" required class="form-control"
                                                name="gl_account" id="gl_account" rows="3">
                                            </textarea>

                                            <!-- FOR ERRORS -->
                                            <div class="validation-Error">
                                                <span
                                                    ng-show="frm_update.gl_account.$dirty && frm_update.gl_account.$error.required">
                                                    <p class="error-display">This field is required.</p>
                                                </span>
                                            </div>
                                        </div>
