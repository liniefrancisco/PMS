                        ...
                        <div class="tab-content ng-cloak">
                            <div role="tabpanel" class="tab-pane active" id="preop">
                                <div class="col-md-10 col-md-offset-3" style="padding-top: 4%;">
                                    <div class="row">
                                        <form
                                            action="<?php echo base_url() ?>index.php/leasing_reports/generate_paymentCollectionByDocno"
                                            method="post" id="frm_collectionReports" name="frm_collectionReports">
                                            <div class="row">
                                                        ...
                                                        <div class="form-group">
                                                            <label for="beginning_date"
                                                                class="col-md-4 control-label text-right"><i
                                                                    class="fa fa-asterisk"></i>Enter Document
                                                                No.</label>
                                                            <div class="col-md-8 text-left">
                                                                <input type="text" name="doc_nos" autocomplete="off"
                                                                    required ng-model="doc_nos" class="form-control" />
                                                                <div class="validation-Error">
                                                                    <span
                                                                        ng-show="frm_collectionReports.doc_nos.$dirty && frm_collectionReports.doc_nos.$error.required">
                                                                        <p class="error-display">This field is required.
                                                                        </p>
                                                                    </span>
                                                                </div>
                                                                <span style="font-weight: bold; font-size: 11px;">
                                                                    <i>Note!</i> You can enter multiple document no.
