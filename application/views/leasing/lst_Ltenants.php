    ...
    <div class="well">
        <div class="panel panel-default">
          ...
          <div class="panel-heading panel-leasing">
                <i class="fa fa-list"></i> Long Term Tenants
            ...
            <div class="panel-body">
                <!-- <div class="alert alert-warning alert-dismissible rounded-0" role="alert">
                    <button type="button" class="close" data-dismiss="alert" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                        <strong>Note!</strong> Please follow format for requesting change BASIC RENTAL/RENT or Location
                        <br><strong>Tenant Rental: </strong><i>Tenant ID, Trade Name, Suggst. Monthly/Rental or Basic Rental, New Rental</i></b>
                        <br><strong>Location: </strong><i>Location Slot, Old Area, New Area (IF AREA NEEDS TO CHANGE), Old Rental, New Rental</i></b>
                        <br>Thank you.</b>
                </div> -->
                <div class="col-md-5 ">
                            <div class="alert alert-warning alert-dismissible rounded-0" role="alert">
                                <button type="button" class="close" data-dismiss="alert" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                                    <h5 style="margin-top:-5px;"><strong >Note!</strong> For requesting change in BASIC RENT </h5>
                                <h5 style="font-size:12px;margin-bottom:5px;">Tenant ID :<br> Tenant Name      : <br>Old Basic Rent :<br> New Basic Rent : </h5></i></b>
                            </div>
                        </div>
                        <div class="col-md-5 ">
                            <div class="alert alert-warning alert-dismissible rounded-0" role="alert">
                                <button type="button" class="close" data-dismiss="alert" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                                    <h5 style="margin-top:-5px;"><strong>Note!</strong> For requesting change in LOCATION SLOT</h5>
                                    <h5 style="font-size:12px;margin-bottom:-5px;">Slot No. :<br>Old Floor Area :<br>New Floor Area : <br>Old Rental Rate :<br> New Rental Rate :</h5> </i></b>
                ...
                <div class="row">
                    <div class="col-md-12">
                        <table class="table table-bordered" ng-table = "tableParams" ng-init="loadList('<?php echo base_url(); ?>index.php/leasing_transaction/get_Ltenants')">
                            ...
                            <tbody>
                                <tr class="ng-cloak"ng-repeat= "tenant in data">
                                    ...
                                    <td title = "'Active'" align="center" width="100px">
                                        <div class="btn-group">
                                            ...
                                            <ul class="dropdown-menu">
                                                <li>
                                                    <a
                                                        ...
                                                        ng-click="viewing('<?php echo base_url(); ?>index.php/leasing_transaction/tenant_details/' + tenant.id); getcontractdocuments(tenant.id);">
                                                        <i class = "fa fa-eye"></i> View Details
                                                    </a>
                                                </li>
                                                <?php if (!in_array($this->session->userdata('user_type'), ['Legal', 'IAD'])): ?> <!-- modified by gwaps -->
                                                                                            <li>
                                                                                                <a
                                                                                                    href="#"
                                                                                                    data-backdrop = "static" data-keyboard = "false"
                                                                                            ...
                                                                                            <li>
                                                                                                                                    <a
                                                                                                                                        href          ="#"
                                                                                                                                        data-backdrop ="static" data-keyboard = "false"
                                                                                                                                        ng-click      ="uploadToPortal(tenant.id)">
                                                                                                                                        <i class = "fa fa-arrow-up"></i> Upload to Portal
                                                                                                                                    </a>
                                                                                                                                </li>
                                                <?php endif; ?>
                                            </ul>
                                    ...
                                    <div class = "col-md-12">
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <div class="row">
                                                    <div class="form-group">
                                                        <label for="slot_no" class="col-md-4 control-label text-right" style="color:green">Location Slot</label>
                                                        <div class="col-md-8">
                                                            <input
                                                                type="text"
                                                                required
                                                                readonly
                                                                ng-model = "detail.slot_no"
                                                                class="form-control"
                                                                id="slot_no"
                                                                name = "slot_no"
                                                                autocomplete="off" >
                                                ...
                                                <div class="row" ng-if = "detail.is_incrementable > 0">
                                                    <div class="form-group">
                                                        <label for="rent_increment" class="col-md-4 control-label text-right"></i>Monthly Rental plus Rent Increment {{detail.is_incrementable}}</label>
                                                        <div class="col-md-8">
                                                            <div class="input-group">
                                                                <div class="input-group-addon"><strong>&#8369;</strong></div>
                                                                    <!-- <input
                                                                    ng-if="detail.tenant_id !== 'PM-LT000100'"
                                                                    type="text"
                                                                    readonly
                                                                    ng-value = "(detail.basic_rental * power(1+(detail.increment_percentage/100),detail.is_incrementable)) | currency:''"
                                                                    class="form-control currency"
                                                                    name = "rent_increment"
                                                                    autocomplete="off" >
                                                                    <input
                                                                    ...
                                                                    type="text"
                                                                    readonly
                                                                    ng-value = "(detail.basic_rental) | currency:''"
                                                                    class="form-control currency"
                                                                    name = "rent_increment"
                                                                    autocomplete="off" > -->
                                                                    <!----------------------------------- gwaps ------------------------------------->
                                                                    <input
                                                                    ng-if="detail.tenant_id !== 'PM-LT000100' && detail.tenant_id !== 'ACT-LT000027'" 
                                                                    type="text"
                                                                    readonly
                                                                    ng-value = "(detail.basic_rental * power(1 + (detail.increment_percentage / 100), detail.is_incrementable)) | currency:''"
                                                                    ...
                                                                    autocomplete="off" >
                                                                    <input
                                                                    ng-if="detail.tenant_id === 'ACT-LT000027'"
                                                                    type="text"
                                                                    readonly
                                                                    ng-value="(detail.basic_rental * power(1 + detail.increment_percentage / 100, detail.is_incrementable1)) | currency:''"
                                                                    class="form-control currency"
                                                                    name = "rent_increment"
                                                                    autocomplete="off" >
                                                                    <!------------------------------------ gwaps ends ----------------------------------->
                                    ...
                                    <div class="col-md-12" ng-repeat="data in dataList">
                                        <div class="container-fluid">
                                            <table class="table table-bordered">
                                                ...
                                                <tbody>
                                                    <tr>
                                                        <td><img src="<?php echo base_url(); ?>img/Folder-icon.png" alt="Letter of Intent" style = "height:20px;"> Letter of Intent</td>
                                                        <td><button class="btn btn-sm primary button-w" data-toggle="modal" data-target="#carousel_modal" ng-click="get_img('<?php echo base_url(); ?>index.php/leasing_transaction/get_letter/' + data.prospect_id, '<?php echo base_url(); ?>assets/intent_letter/')">View Document</button></td>
                                                    </tr>
                                                    <tr>
                                                        <td><img src="<?php echo base_url(); ?>img/Folder-icon.png" alt="Company Profile" style = "height:20px;"> Company Profile</td>
                                                        <td><button class="btn btn-sm primary button-w" data-toggle="modal" data-target="#carousel_modal" ng-click="get_img('<?php echo base_url(); ?>index.php/leasing_transaction/get_comprof/' + data.prospect_id, '<?php echo base_url(); ?>assets/other_img/')">View Document</button></td>
                                                    </tr>
                                                    <tr>
                                                        <td><img src="<?php echo base_url(); ?>img/Folder-icon.png" alt="DTI Business Registration" style = "height:20px;"> DTI Business Registration</td>
                                                       <td><button class="btn btn-sm primary button-w" data-target="#carousel_modal" ng-click="get_img('<?php echo base_url(); ?>index.php/leasing_transaction/get_dtibusireg/' + data.prospect_id, '<?php echo base_url(); ?>assets/other_img/')">View Document</button></td>
                                                    </tr>
                                                    <tr>
                                                        <td><img src="<?php echo base_url(); ?>img/Folder-icon.png" alt="Picture/Brochures of Products" style = "height:20px;"> Picture/Brochures of Products</td>
                                                        <td><button class="btn btn-sm primary button-w" data-toggle="modal" data-target="#carousel_modal" ng-click="get_img('<?php echo base_url(); ?>index.php/leasing_transaction/get_brochures/' + data.prospect_id, '<?php echo base_url(); ?>assets/other_img/')">View Document</button></td>
                                                    </tr>
                                                    <tr>
                                                        <td><img src="<?php echo base_url(); ?>img/Folder-icon.png" alt="Gross Sales(Percentage rent.)" style = "height:20px;"> Gross Sales(Percentage rent.)</td>
                                                        <td><button class="btn btn-sm primary button-w" data-toggle="modal" data-target="#carousel_modal" ng-click="get_img('<?php echo base_url(); ?>index.php/leasing_transaction/get_gsalesImg/' + data.prospect_id, '<?php echo base_url(); ?>assets/other_img/')">View Document</button></td>
                                                    </tr>
                                                    <tr>
                                                        <td><img src="<?php echo base_url(); ?>img/Folder-icon.png" alt="Price/Menu List(for food tenants)" style = "height:20px;"> Price/Menu List(for food tenants)</td>
                                                        <td><button class="btn btn-sm primary button-w" data-toggle="modal" data-target="#carousel_modal" ng-click="get_img('<?php echo base_url(); ?>index.php/leasing_transaction/get_pricemenuList/' + data.prospect_id, '<?php echo base_url(); ?>assets/other_img/')">View Document</button></td>
                                                    </tr>
                                                    <tr>
                                                        <td><img src="<?php echo base_url(); ?>img/Folder-icon.png" alt="Contract Documents" style = "height:20px;"> Contract Documents</td>
                                                        <td> 
                                                            <div class="col-md-6">
                                                                <select name = "contract_docs"
                                                                    id="contract_docs"
                                                                    required
                                                                    ng-model = "contract_docs"
                                                                    class = "form-control">
                                                                <option value="" disabled="" selected="" style = "display:none">Please Select One</option>
                                                                <option ng-repeat="d in docs" value="{{d.term}}">{{d.term}}</option>
                                                            </select> 
                                                            </div>
                                                            <button class="btn btn-sm primary button-w" data-target="#image_viewer" data-toggle="modal" ng-click="getContractDoc(detail.tenant_id, contract_docs)" ng-disabled="!contract_docs">View Document</button>
                                                            <button class="btn btn-sm primary button-w" data-target="#image_viewer" data-toggle="modal" ng-click="getContractDoc2(detail.tenant_id)">View Old Uploaded Documents</button>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td><img src="<?php echo base_url(); ?>img/Folder-icon.png" alt="Supporting Documents" style = "height:20px;"> Supporting Documents</td>
                                                        <td><button class="btn btn-sm primary button-w" data-toggle="modal" data-target="#carousel_modal" ng-click="get_img('<?php echo base_url(); ?>index.php/leasing_transaction/get_suppDocs/' + detail.tenant_id, '<?php echo base_url(); ?>assets/other_img/')">View Document</button></td>
                                                    </tr>
                                                </tbody>
                                            </table>                                
                                        </div>
...
<?php if ($this->session->userdata('user_type') != 'Accounting Staff' && $this->session->userdata('user_type') != 'Legal' && $this->session->userdata('user_type') != 'IAD'): ?> <!-- modified by gwaps -->
                                                                        ...
                                                                        <button 
                                                                                ...
                                                                                href="#"
                                                                                ng-click = "managers_key('<?php echo base_url(); ?>index.php/leasing_transaction/tenant_amendment/' + detail.id)"> 
                                ...
                                data-dismiss="modal" 
                                data-toggle="modal"
                                ng-click = "managers_key('<?php echo base_url(); ?>index.php/leasing_transaction/approve_prospect/' + data.id + '/' + data.store_name)"
                                data-target="#manager_modal"> 
                                <i class = "fa fa-thumbs-up"></i> Approve Request
                                                                        ...
                                                                        <?php if ($this->session->userdata('user_type') == 'Administrator'): ?>
                                                                                                                        ...
                                                                                                                        <button 
                                                                                                                                ...
                                                                                                                                href="#"
                                                                                                                                ng-click = "confirm('<?php echo base_url(); ?>index.php/leasing_transaction/setup_forOtherContract/' + detail.prospect_id)"> 
                                                                                                                                <i class="fa fa-file-text-o"></i> Setup Profile for Contract
                                                                                                                        </button>
                                                                        ...
                                                                        <button 
                                                                                ...
                                                                                data-dismiss="modal" 
                                                                                data-toggle="modal"
                                                                                ng-click = "terminate_reason(detail.id)"
                                                                                data-target="#contract_termination"> 
                                                                                <i class="fa fa-ban red" aria-hidden="true"></i> Terminate Contract
                                                                        </button>
                    ...
                    <div class="modal-body" >
                        <div class="row">
                            <div class="col-md-12">
                                <div class="alert alert-warning alert-dismissible rounded-0" role="alert">
                                    <button type="button" class="close" data-dismiss="alert" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                                    <strong>Note!</strong> When adding multiple contact number separate it by slash(/), same as email.
                                </div>
                                    <div role="tabpanel" class="tab-pane active ng-cloak" id="details">
                                        <div class = "col-md-12">
                                            <div class="row">
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <div class="col-md-8">
                                                                <input
                                                                    ...
                                                                    autocomplete="off" >
                                                                <div class="validation-Error">
                                                                    <span ng-show="frm_updateDetails.email.$dirty && frm_updateDetails.email.$error.required">
                                                                        <p class="error-display">This field is required.</p>
                                                                    </span>
                                                                </div>
                                                            </div>
                        ...
                        <div class="modal-footer">
                            <button type="submit" ng-disabled = "frm_updateDetails.$invalid"  class="btn btn-primary button-b"> <i class = "fa fa-save"></i> <span id = "adding">Submit</span> </button>
                            <button type="button" class="btn btn-danger button-r" data-dismiss="modal"> <i class = "fa fa-close"></i> Close</button>
                        </div>
                </form>
                </div> <!-- end of modal body-->
    ...
    <div class="modal fade" id = "image_viewer" style="overflow-y: scroll; background: #000;">
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                    <h4 class="modal-title"><i class="fa fa-info-circle"></i> View Documents</h4>
                </div>
                <div class="modal-body ng-cloak">
                    <div class="container">
                        <div id="myCarousel" class="carousel slide" data-interval="false">
                            <ol class="carousel-indicators">
                                <li ng-repeat="i in image" data-target="#myCarousel" data-slide-to="{{$index}}" ng-class="{ active: ($index === 0)}"></li>
                            </ol>
                            <div class="carousel-inner" role="listbox" style="min-height: 400px;">
                                <div ng-if = "!image || image.length == 0" class = "item active center-block">
                                    <img src = "<?= base_url() ?>img/thumbnail1.png" alt = "Default" class = "img-responsive">
                                </div>
                                <div ng-repeat = "i in image" ng-class = "{item: true, active: ($index === 0)}">
                                    <center><label>{{ i.file_name }}</label></center>
                                    <center><label>Page {{$index + 1}}/{{image.length}}</label></center>
                                    <img src = "http://172.16.170.10/PMS/assets/contract_docs/{{ i.file_name }}" alt = "{{ i.file_name }}" style = "width:100%;">
                                </div>
                            </div>
                        ...
                        <div class = "modal-footer"> 
                            <button type = "button" class = "btn btn-danger button-r" data-dismiss = "modal" ng-click = "imageClose()"> 
