        ...
        <div class="panel panel-default">
          <!-- Default panel contents -->
            <div class="panel-heading panel-leasing">
                <i class="fa fa-list"></i> Short Term Pending Contracts 
            ...
            <div class="panel-body">
                ...
                <div class="row">
                    <div class="col-md-12">
                        <table class="table table-bordered" ng-table = "tableParams" ng-init="loadList('<?php echo base_url(); ?>index.php/leasing_transaction/pending_scontracts')">
                                    ...
                                    <td title = "'Action'" align="center" width="100px">
                                        <div class="btn-group">
                                            ...
                                            <ul class="dropdown-menu">
                                               ...
                                               <!--  <li ng-if = "'<?php echo $this->session->userdata('user_type'); ?>' != 'Store Manager' && '<?php echo $this->session->userdata('user_type'); ?>' != 'Supervisor' && '<?php echo $this->session->userdata('user_type'); ?>' != 'Corporate Leasing Supervisor'">
                                                    <a 
                                                        href="#" 
                                                        data-toggle="modal"
                                                        data-backdrop="static" data-keyboard="false"
                                                        ng-click = "managers_key('<?php echo base_url(); ?>index.php/leasing_transaction/post_spendingContract/' + tenant.id)"
                                                ...
                                                <li ng-if = "'<?php echo $this->session->userdata('user_type'); ?>' == 'Store Manager' || '<?php echo $this->session->userdata('user_type'); ?>' == 'Supervisor' || '<?php echo $this->session->userdata('user_type'); ?>' == 'Corporate Leasing Supervisor'">
                                                    <a 
                                                        href="<?php echo base_url(); ?>index.php/leasing_transaction/post_spendingContract/{{tenant.id}}"> 
                                                        <i class = "fa fa-save"></i> Post
                                                    </a>    
                                                </li>  -->
            ...
            <div class="modal-content">
                ...
                <div class="modal-body ng-cloak" ng-repeat = "detail in viewList">
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <ul class="nav nav-tabs" role="tablist"> 
                                ...
                                <li role="presentation"><a href="#charges" aria-controls="charges" ng-click = "details('<?php echo base_url(); ?>index.php/leasing_transaction/selected_monthly_charges/' + detail.tenant_id)" role="tab" data-toggle="tab">Charges</a></li>
                                            ...
                                            <div class="panel panel-default">
                                                ...
                                                <div class="panel-body">
                                                    <table class="table table-bordered" >
                                                        ...
                                                        <tbody>
                                                            <tr class="ng-cloak" ng-show="dataList.length!=0" ng-repeat= "charge in dataList | filter:query | orderBy:sortField:reverse | offset: currentPage*itemsPerPage | limitTo: itemsPerPage">
                                            ...
                                            <table class="table table-bordered">
                                                ...
                                                <tbody>
                                                    <tr>
                                                        ...
                                                        <td><button class="btn btn-sm button-w" data-toggle="modal" data-target="#carousel_modal" ng-click="get_img('<?php echo base_url(); ?>index.php/leasing_transaction/get_proposal/' + detail.prospect_id, '<?php echo base_url(); ?>assets/exhibitor_attachements/')">View</button></td>
                                                    </tr>
                                                    <tr>
                                                        <td>Company Profile</td>
                                                        <td><button class="btn btn-sm button-w" data-toggle="modal" data-target="#carousel_modal" ng-click="get_img('<?php echo base_url(); ?>index.php/leasing_transaction/get_excomprof/' + detail.prospect_id, '<?php echo base_url(); ?>assets/exhibitor_attachements/')">View</button></td>
                                                    </tr>
                                                    <tr>
                                                        <td>Booth Layout</td>
                                                        <td><button class="btn btn-sm button-w" data-toggle="modal" data-target="#carousel_modal" ng-click="get_img('<?php echo base_url(); ?>index.php/leasing_transaction/get_boothlayout/' + detail.prospect_id, '<?php echo base_url(); ?>assets/exhibitor_attachements/')">View</button></td>
                                                    </tr>
                                                    <tr>
                                                        <td>Booth Perpspective</td>
                                                        <td><button class="btn btn-sm button-w" data-toggle="modal" data-target="#carousel_modal" ng-click="get_img('<?php echo base_url(); ?>index.php/leasing_transaction/get_experspective/' + detail.prospect_id, '<?php echo base_url(); ?>assets/exhibitor_attachements/')">View</button></td>
                                                    </tr>
                                                    <tr>
                                                        <td>DTI Business Registration</td>
                                                        <td><button class="btn btn-sm button-w" data-toggle="modal" data-target="#carousel_modal" ng-click="get_img('<?php echo base_url(); ?>index.php/leasing_transaction/get_exdti_busireg/' + detail.prospect_id, '<?php echo base_url(); ?>assets/exhibitor_attachements/')">View</button></td>
                                                    </tr>
                                                    <tr>
                                                        <td>Award Notices</td>
                                                        <td><button class="btn btn-sm button-w" data-toggle="modal" data-target="#carousel_modal" ng-click="get_img('<?php echo base_url(); ?>index.php/leasing_transaction/get_contractDocs/' + detail.tenant_id, '<?php echo base_url(); ?>assets/contract_docs/')">View</button></td>
                                                    </tr>
                                                </tbody>
                                            </table>        
                                        </div>
                    ...
                    <div class="modal-footer">
                        <?php if ($this->session->userdata('user_type') == 'Store Manager' || $this->session->userdata('user_type') == 'Supervisor' || $this->session->userdata('user_type') == 'Corporate Leasing Supervisor'): ?>
                                                                ...
                                                                <button 
                                                                        ...
                                                                        href="#"
                                                                        ng-click = "confirm('<?php echo base_url(); ?>index.php/leasing_transaction/post_spendingContract/' + detail.id)"> 
                        ...
                        <?php else: ?>  
                                ...
                                <i class = "fa fa-save"></i> Post
                                                                ...
                                                                <button 
                                                                        ...
                                                                        data-dismiss="modal" 
                                                                        data-toggle="modal"
                                                                        ng-click = "managers_key('<?php echo base_url(); ?>index.php/leasing_transaction/post_spendingContract/' + detail.id)"
                                                                        data-target="#manager_modal"> 
                                                                        <i class = "fa fa-save" style="color: green;"></i> Post
                                                                </button>     
