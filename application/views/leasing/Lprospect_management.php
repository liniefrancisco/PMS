                                            ...
                                            <ul class="dropdown-menu">
                                                ...
                                                <!-- <li>
                                                    ...
                                                    <a
                                                        ...
                                                        <i class = "fa fa-thumbs-down"></i> Decline Request
                                                    </a>
                                                    <?php else: ?>
                                                    <a
                                                        href="#"
                            ...
                            <div class="col-md-12">
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="row">
                                            <div class="form-group">
                                                <label for="email" class="col-md-4 control-label text-right"><i class = "fa fa-asterisk"></i>Email</label>
                                                <div class="col-md-8">
                                                    <input
                                                        type="text"
                                                        required
                                                    ...
                                                    <!-- FOR ERRORS -->
                                                    <div class="validation-Error">
                                                        <span ng-show="frm_update.email.$dirty && frm_update.email.$error.required">
                                                            <p class="error-display">This field is required.</p>
                                                        </span>
                                                    </div>
                                                </div>
        ...
        <div class="modal-dialog modal-xl">
            <div class="modal-content">
                ...
                <div class="modal-body ng-cloak" ng-repeat = "data in viewList">
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="row">
                                <div class="form-group">
                                    ...
                                    <div class="col-md-8">
                                        <span ng-if="data.email != '' || data.email != null" class = "details">{{ data.email }}</span>
                    ...
                    <div class="modal-footer">
                    <?php if (in_array($this->session->userdata('user_type'), ['Administrator', 'Store Manager', 'Supervisor'])): ?>
                                        <button 
                                                type        ="button" 
                                                ...
                                                href        ="#"
                                                ng-click    ="confirm('<?php echo base_url(); ?>index.php/leasing_transaction/approve_prospect/' + data.id)"> 
                                                <i class    ="fa fa-thumbs-up"></i> Approve Request
                                        </button>
                                        <button 
                                                type        ="button" 
                    ...
                    <?php endif; ?>
                    <?php if (in_array($this->session->userdata('user_type'), ['Administrator', 'Store Manager'])): ?>
                                        <button 
                                                type        ="button" 
                                                class       ="btn btn-alert button-w" 
                                                data-dismiss="modal"
                                                ...
                                                data-target ="#confirmation1_modal"
                                                href        ="#"
                                                ng-click    ="confirm('<?php echo base_url(); ?>index.php/leasing_transaction/deny_prospect/' + data.id)">
                    ...
                    <?php else: ?>
                                        <button 
                                                ...
                                                href        ="#"
                                                data-toggle ="modal"
                                                ng-click    ="decline_remarks(data.id, data.store_name, data.trade_name, '<?php echo base_url(); ?>index.php/leasing_transaction/deny_prospectV2/')"
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <div class="alert alert-warning alert-dismissible rounded-0" role="alert">
                                    ...
                                    <strong>Note!</strong> Please follow Address Format, St. No./Bldg No., Street Name, Barangay, City or Municipality, Province, Postal Code.
                                </div>
                                <div class="alert alert-warning alert-dismissible rounded-0" role="alert">
                                    <button type="button" class="close" data-dismiss="alert" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-8">
                                                    <input
                                                        ...
                                                        name = "address"
                                                        autocomplete="off"
                                                        placeholder="St. No./Bldg No., Street Name, Barangay, City or Municipality, Province">
                                        ...
                                        <div class="row">
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-8">
                                                    ...
                                                    <!-- FOR ERRORS -->
                                                    <div class="validation-Error">
                                                        <span ng-show="add_form.email.$dirty && add_form.email.$error.required">
                                                            <p class="error-display">This field is required.</p>
                                                        </span>
                                                    </div>
                                                </div>
                                                ...
                                                <div class = "col-md-4">
                                                    <div class="input-group">
                                                        ...
                                                        <input
                                                            ...
                                                            class="form-control"
                                                            autocomplete="off">
                                                    </div> <!-- <?php echo $this->session->userdata('first_name'); ?> <?php echo $this->session->userdata('last_name'); ?> -->
                                                </div>
                                            </div>
                                        </div>
                                    </div>
