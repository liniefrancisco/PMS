    ...
    <div class="well">
        <div class="panel panel-default">
            ...
            <div class="panel-heading panel-leasing">
                <i class="fa fa-list"></i> Terminated Short Term Contracts
                ...
                <div class="row">
                    <div class="col-md-12">
                        <table class="table table-bordered" ng-table="tableParams"
                            ng-init="loadList('<?php echo base_url(); ?>index.php/leasing_transaction/terminated_stenant')">
                            ...
                            <tbody>
                                <tr class="ng-cloak" ng-repeat="dt in data">
                                    ...
                                    <td title="'Date of Termination'" sortable="'termination_date'">
                                        {{dt.termination_date}}</td>
