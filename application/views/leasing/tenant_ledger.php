                                                ...
                                                <div role="tabpanel" class="tab-pane active" id="payment">
                                                    ...
                                                    <div class="row"> <!-- table wrapper  -->
                                                    	...
                                                    	<div class="col-md-12" ng-if = "contract_no">
                                                        	<a class="btn btn-default btn-medium pull-right button-w" href="<?php echo base_url(); ?>index.php/leasing_transaction/export_tenantLedger/{{tenant_id}}"  ><i class="fa fa-download"></i> Export Excel</a>
                                                        </div>
                                                    </div>
                                                </div>
