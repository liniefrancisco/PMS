                        ...
                        <div class="tab-content ng-cloak">
                            <div role="tabpanel" class="tab-pane active" id="preop">
                                <div class="col-md-10 col-md-offset-3" style="padding-top: 4%;">
                                    <div class="row">
                                        <form action=""
                                            onSubmit="delinquent_tenants('<?php echo base_url() ?>index.php/Leasing_reports/generate_delinquent_tenants'); return false"
                                            method="post" id="frm_delinquentTenants" name="frm_delinquentTenants">
                                            <div class="row">
                                                            ...
                                                            <div class="col-md-8 text-left">
                                                                <div class="input-group">
                                                                    ...
                                                                    <div class="validation-Error">
                                                                        <span
                                                                            ng-show="frm_delinquentTenants.from_date.$dirty && frm_delinquentTenants.from_date.$error.required">
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <div class="col-md-8 text-left">
                                                                <div class="input-group">
                                                                    ...
                                                                    <div class="validation-Error">
                                                                        <span
                                                                            ng-show="frm_delinquentTenants.as_of_date.$dirty && frm_delinquentTenants.as_of_date.$error.required">
                                                                            <p class="error-display">This field is
                                                                                required.</p>
                                                                        </span>
                                                                    </div>
                                            ...
                                            <div class="col-md-6">
                                                <div class="row pull-right" style="padding-right: 13%">
                                                    <div class="col-md-12">
                                                        <button type="submit"
                                                            ng-disabled="frm_delinquentTenants.$invalid"
