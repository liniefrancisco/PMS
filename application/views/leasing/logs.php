                ...
                <form action="<?php echo base_url(); ?>index.php/leasing_archive/delete_logs/" method="post">
                    <div class="row">
                        ...
                        <div class="col-md-3 pull-left">
                            <button type="submit" class="btn btn-medium btn-danger button-r"><i class="fa fa-trash"></i>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <table class="table table-bordered" ng-controller="tableController"
                                ng-init="loadList('<?php echo base_url(); ?>index.php/leasing_archive/get_logs')">
                                <thead>
                                    <tr>
                                        <th><input type="checkbox" name="checkall" id="checkall"
                                                ng-click="checkall('checkall', 'checkbox')" /></th>
                                        <th><a href="#" data-ng-click="sortField = 'user'; reverse = !reverse">User</a>
                                        </th>
                                        <th><a href="#"
                                                data-ng-click="sortField = 'action'; reverse = !reverse">Action</a></th>
                                        <th><a href="#" data-ng-click="sortField = 'date'; reverse = !reverse">Date</a>
                                        </th>
                                    </tr>
                                </thead>
                                <tbody>
                                    <tr class="ng-cloak" ng-show="dataList.length!=0"
                                        ng-repeat="log in dataList | filter:query | orderBy:sortField:reverse | offset: currentPage*itemsPerPage | limitTo: itemsPerPage">
                                        <td><input type="checkbox" name="checkbox[]" value="{{log.id}}" id="checkbox">
                                        </td>
                                        <td>{{ log.user }}</td>
                                        <td>{{ log.action }}</td>
                                        <td>{{ log.date }}</td>
                                            ...
                                            <div>
                                                <ul class="pagination">
                                                    ...
                                                    <li ng-show="dataList.length!=0 && (dataList | filter:query).length != 0"
                                                        ...
                                                        <a href ng-click="nextPage()" style="border-radius: 0px;">Next
