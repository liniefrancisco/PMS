                                ...
                                <div class="row"> <!-- table wrapper  -->
                                            ...
                                            <div class="col-md-4">
                                                <div class="row pull-left">
                                                    <div class="form-group">
                                                        ...
                                                        <button type="button"
                                                            ng-click="ajaxLoadList('<?php echo base_url(); ?>index.php/leasing_reports/get_agingRR/', date_created)"
                                                            class="btn btn-medium btn-info button-b"
                                    ...
                                    <div class="col-md-12" ng-if="ajaxData.length!=0">
                                        <a class="btn btn-default btn-medium pull-right button-w"
                                            onclick="generate_aging('<?php echo base_url(); ?>index.php/leasing_reports/export_agingRR/')"><i
