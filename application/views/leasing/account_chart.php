                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <table class="table table-bordered" ng-table="tableParams" ng-controller="tableController"
                                ng-init="loadList('<?php echo base_url(); ?>index.php/leasing_reports/get_accountChart/')">
                                <thead>
                                    <tr>
                                        <th width="30%"><a href="#"
                                                data-ng-click="sortField = 'classification'; reverse = !reverse">G/L
                                                Code</a></th>
                                        <th width="40%"><a href="#"
                                                data-ng-click="sortField = 'description'; reverse = !reverse">G/L
                                                Accounts</a></th>
                                        <th width="20%"><a href="#"
                                                data-ng-click="sortField = 'description'; reverse = !reverse">Amount</a>
                                        </th>
                                ...
                                <tbody>
                                    <tr class="ng-cloak" ng-repeat="dt in data">
                                        ...
                                        <td title="'Amount'" sortable="'amount'" align="right">{{ dt.amount | currency :
                                            '' }}</td>
                                        <td align="center">
                                            <!-- Split button -->
                                            <div class="btn-group">
                                                ...
                                                <ul class="dropdown-menu">
                                                    <li><a href="#" data-backdrop="static" data-keyboard="false"
                                                            ...
                                                            ng-click="loadList2('<?php echo base_url(); ?>index.php/leasing_reports/get_GLaccount/' + dt.gl_code)">
                            ...
                            <div class="col-md-12">
                                <table class="table table-bordered">
                                    <thead>
                                        <tr>
                                            <th><a href="#"
                                                    data-ng-click="sortBy = 'posting_date'; reverse = !reverse">Posting
                                                    Date</a></th>
                                            <th><a href="#"
                                                    data-ng-click="sortBy = 'doc_no'; reverse = !reverse">Document
                                                    No.</a></th>
                                            <th><a href="#" data-ng-click="sortBy = 'ref_no'; reverse = !reverse">Ref
                                                    No.</a></th>
                                            <th><a href="#" data-ng-click="sortBy = 'gl_code'; reverse = !reverse">GL
                                                    Code</a></th>
                                            <th><a href="#"
                                                    data-ng-click="sortBy = 'amount'; reverse = !reverse">Amount</a>
                                            </th>
                                            <th width="10%">Action</th>
                                        </tr>
                                    </thead>
                                        ...
                                        <tr class="ng-cloak" ng-show="dataList2.length!=0"
                                            ...
                                            <td align="center">
                                                ...
                                                <div class="btn-group">
                                                    ...
                                                    <ul class="dropdown-menu">
                                                        <li><a href="#" data-backdrop="static" data-keyboard="false"
                                                                data-toggle="modal" data-target="#navigate"
                                                                ng-click="navigate('<?php echo base_url(); ?>index.php/leasing_reports/navigate/' + data.id)">
                                                                <i class="fa fa-eye"></i> Navigate</a></li>
                                                    </ul>
                                                </div>
                                            </td>
                                        </tr>
                            ...
                            <div class="col-md-12">
                                <table class="table table-bordered">
                                    ...
                                    <tbody>
                                        ...
                                        <tr class="ng-cloak"
                                            ng-show="navigateData.length==0 || (navigateData | filter:query2).length == 0">
                                            <td colspan="8">
                                                <center>No Data Available.</center>
                                            </td>
                                        </tr>
