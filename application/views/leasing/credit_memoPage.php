                                        ...
                                        <form action="#"  method="post" id="frm_creditMemo" name = "frm_creditMemo">
                                            ...
                                            <div class="row"> <!-- ROW FOR BUTTONS -->
                                                <div class = "col-md-12 text-right">
                                                    <button type = "button" data-toggle="modal" data-target="#managerkey_modal" ng-disabled = "frm_creditMemo.$invalid" class = "btn btn-primary btn-medium button-b"><i class = "fa fa-save"></i> Post</button>
                                                </div>
                                            </div>
                                        </form>
                                    </div>
    ...
    <div class="modal-dialog modal-md">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="modal-footer">
                    <a href="#" id="append_penalty_charges" class="btn btn-primary  button-b"><i class="fa fa-save"></i> Append</a>
                    <button type="button" class="btn btn-danger button-r" data-dismiss="modal"> <i class="fa fa-close"></i> Close</button>
                </div>
            </div><!-- /.modal-content -->
        </div><!-- /.modal-dialog -->
    ...
    <div class="modal-dialog modal-md">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="modal-footer">
                    <a href="#" id="append_monthly_charges" class="btn btn-primary button-b"><i class="fa fa-save"></i> Append</a>
                    <button type="button" class="btn btn-danger button-r" data-dismiss="modal"> <i class="fa fa-close"></i> Close</button>
                </div>
            </div><!-- /.modal-content -->
        </div><!-- /.modal-dialog -->
    ...
    <div class="modal-dialog modal-sm">
        <div class="modal-content">
            ...
            <form action="#"  method="post" id="frm_managerKey" name = "frm_managerKey">
                ...
                <div class="modal-footer">
                    <button type="button" onclick="save_creditMemo('<?php echo base_url(); ?>index.php/leasing_transaction/save_creditMemo/')" class="btn btn-primary button-b" data-dismiss="modal"> <i class="fa fa-save"></i> Submit</button>
